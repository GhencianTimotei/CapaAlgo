...
typedef enum
{
    LPSPI0_CLOCK_4_MHZ_E,
    LPSPI0_CLOCK_24_MHZ_E
}TYPE_EN_LPSPI0_PERIPHERAL_INPUT_CLOCK;
...
extern void LPSPI0_enable(void);
extern void LPSPI0_disable(void);
extern status_t LPSPI0_MasterSyncTransmit(const uint8 * sendBuffer,  uint8 * receiveBuffer,  uint16 transferByteCount);
