...
#endif
#ifndef COM_PROCESSOR_S32K144
#define COM_PROCESSOR_S32K144
#endif
#ifndef COM_COMP_IAR
#define COM_COMP_IAR
#endif
...
#define ComConf_ComSignal_B_ActiveMode                                0u
#define ComConf_ComSignal_B_ActuatorControl                           1u
#define ComConf_ComSignal_B_InductiveEnabled                          2u
#define ComConf_ComSignal_B_LockEnabled                               3u
#define ComConf_ComSignal_B_UnlockEnabled                             4u
#define ComConf_ComSignal_E_LedMode                                   5u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_B_Inductive                                 0u
#define ComConf_ComSignal_B_LedActive                                 1u
#define ComConf_ComSignal_B_LockApproach                              2u
#define ComConf_ComSignal_B_LockTouch                                 3u
#define ComConf_ComSignal_B_UnlockApproach                            4u
#define ComConf_ComSignal_DEV_NFC_FS_Resp_3F_Data_XIX_DEV_NFC_FS_Resp_3F_XIX_HCP4_CANFD01_56a7f80a_Tx 5u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComIPduGroup_AlwaysOnRx                               0u
#define ComConf_ComIPduGroup_AlwaysOnTx                               1u
#define ComConf_ComIPduGroup_CommunicationControlRx                   2u
#define ComConf_ComIPduGroup_CommunicationControlTx                   3u
/**\} */
