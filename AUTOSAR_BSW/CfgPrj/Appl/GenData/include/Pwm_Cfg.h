...
#define PWM_CFG_AR_RELEASE_MINOR_VERSION          3
#define PWM_CFG_AR_RELEASE_REVISION_VERSION       1
...
*/
#define PTA11_LIGHT_PWM         ((Pwm_ChannelType)0U)

/** 
* @brief           Symbolic Names for configured channels - ecuc 2108 compliant.
*/

#define  PwmConf_PwmChannelConfigSet_PTA11_LIGHT_PWM         ((Pwm_ChannelType)0U)
...
#define PWM_HW_CHANNELS_NO_U8           ((uint8)0U + PWM_FTM_CHANNELS_NO)

#define PWM_HW_MODULES_CFG_U8           ((uint8)0U + PWM_FTM_MODULE_NO)
...
*
*/
#define IDX_FIRST_FTM_CH_IN_HW_REVERSE_MAP    (0U)
