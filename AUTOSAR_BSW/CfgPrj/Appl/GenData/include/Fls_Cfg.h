...
#define FLS_TRANSIENT_FAULT_DETECT  (STD_OFF)
...
#define FLS_MAX_ERASE_BLANK_CHECK   (64U)
...
#define Fls_PBCfgVariantPredefined FlsConfigSet/* @violates @ref Fls_Cfg_H_REF_2 Could define variable at block scope */
