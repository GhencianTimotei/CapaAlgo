...
*/
        ...
        #define GptConf_GptChannelConfiguration_GptChannelConfiguration_INTOS (0U)
            

            /** @violates @ref GPT_CFG_H_REF_2 Identifier clash */
        #define GptConf_GptChannelConfiguration_GptChannelConfiguration_Timer (1U)
