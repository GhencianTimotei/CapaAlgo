...
#define ADC_AR_RELEASE_MINOR_VERSION_CFG_DEFINES        3
/** @violates @ref Adc_CfgDefines_h_REF_2 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define ADC_AR_RELEASE_REVISION_VERSION_CFG_DEFINES     1
...
*/
#define ADC_HARDWARE_NORMAL_CONVERSIONS_USED       (STD_ON)
...
#define ADC0_CH5_PTB1_U_SPG                       0
#define ADC0_CH9_PTC1_VR_ADC                       1
#define ADC0_CH14_PTC16_ER_ADC                       2
...
#define ADC_GR_ADC0_CH5_PTB1_U_SPG                       0
#define ADC_GR_ADC0_CH9_PTC1_VR_ADC                       1
#define ADC_GR_ADC0_CH14_PTC16_ER_ADC                       2
...
/** @violates @ref Adc_CfgDefines_h_REF_2 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define AdcConf_AdcGroup_ADC_GR_ADC0_CH5_PTB1_U_SPG                       0
/** @violates @ref Adc_CfgDefines_h_REF_2 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define AdcConf_AdcGroup_ADC_GR_ADC0_CH9_PTC1_VR_ADC                       1
/** @violates @ref Adc_CfgDefines_h_REF_2 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define AdcConf_AdcGroup_ADC_GR_ADC0_CH14_PTC16_ER_ADC                       2
