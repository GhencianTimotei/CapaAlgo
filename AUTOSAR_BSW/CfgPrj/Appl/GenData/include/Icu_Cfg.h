...
#define IcuChannel_NFC_REQ_Interrupt                     (IcuConf_IcuChannel_IcuChannel_NFC_REQ_Interrupt)
#define IcuConf_IcuChannel_IcuChannel_NFC_REQ_Interrupt  ((Icu_ChannelType)0U) 
#define IcuChannel_LDC_INTB_Interrupt                     (IcuConf_IcuChannel_IcuChannel_LDC_INTB_Interrupt)
#define IcuConf_IcuChannel_IcuChannel_LDC_INTB_Interrupt  ((Icu_ChannelType)1U) 
#define IcuChannel_CanWakeup                     (IcuConf_IcuChannel_IcuChannel_CanWakeup)
#define IcuConf_IcuChannel_IcuChannel_CanWakeup  ((Icu_ChannelType)2U) 
...
/**
*   @brief ISR's configured for PORT_2 channels
*   @details Macros for channels used in ISR
*/
#define ICU_PORT_2_ISR_USED 


/**
*   @brief ISR's configured for PORT_4 channels
*   @details Macros for channels used in ISR
*/
#define ICU_PORT_4_ISR_USED 
