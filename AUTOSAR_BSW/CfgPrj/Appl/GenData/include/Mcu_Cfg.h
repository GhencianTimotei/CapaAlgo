...
*/
#define MCU_MAX_CLKCONFIGS   ((uint32)3U)
...
#define McuClockSettingConfig_VLPR   ((Mcu_ClockType)1U)
#define McuConf_McuClockSettingConfig_McuClockSettingConfig_VLPR   ((Mcu_ClockType)1U)

#define McuClockSettingConfig_VLPR_001   ((Mcu_ClockType)2U)
#define McuConf_McuClockSettingConfig_McuClockSettingConfig_VLPR_001   ((Mcu_ClockType)2U)
...
#define MCU_MODE_VLPR   ((Mcu_ModeType)1U)
#define McuConf_McuModeSettingConf_MCU_MODE_VLPR   ((Mcu_ModeType)1U)

#define MCU_MODE_RUN   ((Mcu_ModeType)0U)
#define McuConf_McuModeSettingConf_MCU_MODE_RUN   ((Mcu_ModeType)0U)

#define MCU_MODE_VLPS   ((Mcu_ModeType)2U)
#define McuConf_McuModeSettingConf_MCU_MODE_VLPS   ((Mcu_ModeType)2U)
