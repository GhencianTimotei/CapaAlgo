...
extern void Nfc_TimerTickPeriodicalTask(void);
/** @} */
...
,
    {   /*GptChannelConfiguration_Timer configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Nfc_TimerTickPeriodicalTask, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
...
,
    {   /*GptChannelConfiguration_LPTMR configuration data*/
        ...
        NULL_PTR, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType) ((uint32)((uint32)1<<6)), /* Wakeup information */
#endif
        (Gpt_ValueType)(65535U), /* Maximum ticks value*/
        (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        {
            ...
            (uint8)(1U), /* LPTMR Clock Select LPO1K_CLK */ 
#if (GPT_SET_CLOCK_MODE == STD_ON)
            (Gpt_PrescalerType)(0U), /* FTM alternate Clock divider, FTM is not USED */ 
...
CONST(Gpt_ConfigType, GPT_CONST)  GptChannelConfigSet =
{
    ...
    {
        GptConf_GptChannelConfiguration_GptChannelConfiguration_Timer, /*mapping of FTM_0_CH_0*/
        ...
        GptConf_GptChannelConfiguration_GptChannelConfiguration_INTOS, /*mapping of LPIT_0_CH_0*/
