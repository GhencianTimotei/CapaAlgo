...
==================================================================================================*/
  ...
  /* Check if current file and Wdg header file are of the same vendor */
     ...
     #error "Wdg_Lcfg.c and Wdg_Channel.h have different vendor ids"
 #endif
 ...
 /* Check if source file and Wdg header file are of the same Autosar version */
     ...
     #error "AutoSar Version Numbers of Wdg_Lcfg.c and Wdg_Channel.h are different"
 #endif
 /* Check if source file and Wdg header file are of the same Software version */
     ...
     #error "Software Version Numbers of Wdg_Lcfg.c and Wdg_Channel.h are different"
 #endif

 #if (WDG_TYPE == WDG_INTERNAL_MODULE)
     /* Check if source file and Reg_eSys_Wdog_defines header file are of the same vendor */
     #if (WDG_VENDOR_ID_LCFG_C != REG_ESYS_WDOG_DEFINES_VENDOR_ID)
         #error "Wdg_Lcfg.c and Reg_eSys_Wdog_defines.h have different vendor ids"
     #endif

     /* Check if source file and Reg_eSys_Wdog_defines header file are of the same Autosar version */
     #if ((WDG_AR_RELEASE_MAJOR_VERSION_LCFG_C != REG_ESYS_WDOG_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
          (WDG_AR_RELEASE_MINOR_VERSION_LCFG_C != REG_ESYS_WDOG_DEFINES_AR_RELEASE_MINOR_VERSION) || \
          (WDG_AR_RELEASE_REVISION_VERSION_LCFG_C != REG_ESYS_WDOG_DEFINES_AR_RELEASE_REVISION_VERSION))
         #error "AutoSar Version Numbers of Wdg_Lcfg.c and Reg_eSys_Wdog_defines.h are different"
     #endif

     /* Check if source file and Reg_eSys_Wdog_defines header file are of the same Software version */
     #if ((WDG_SW_MAJOR_VERSION_LCFG_C != REG_ESYS_WDOG_DEFINES_SW_MAJOR_VERSION) || \
          (WDG_SW_MINOR_VERSION_LCFG_C != REG_ESYS_WDOG_DEFINES_SW_MINOR_VERSION) || \
          (WDG_SW_PATCH_VERSION_LCFG_C != REG_ESYS_WDOG_DEFINES_SW_PATCH_VERSION))
         #error "Software Version Numbers of Wdg_Lcfg.c and Reg_eSys_Wdog_defines.h are different"
     #endif
 #endif
