...
/* @violates @ref Pwm_PBcfg_C_REF_4 Identifier exceeds 31 chars. */
#define PWM_PBCFG_AR_RELEASE_MINOR_VERSION_C       3
/* @violates @ref Pwm_PBcfg_C_REF_4 Identifier exceeds 31 chars. */
#define PWM_PBCFG_AR_RELEASE_REVISION_VERSION_C    1
...
/* Check if header file and Ftm_Common_Types.h header file are of the same vendor */
#if (PWM_PBCFG_VENDOR_ID_C != PWM_FLEXIO_TYPES_VENDOR_ID)
    #error "Pwm_PBcfg.c and Pwm_FlexIO_Types.h have different vendor ids"
#endif
/* Check if header file and Ftm_Common_Types.h header file are of the same Autosar version */
#if ((PWM_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != PWM_FLEXIO_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_PBCFG_AR_RELEASE_MINOR_VERSION_C    != PWM_FLEXIO_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (PWM_PBCFG_AR_RELEASE_REVISION_VERSION_C != PWM_FLEXIO_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Pwm_PBcfg.c and Pwm_FlexIO_Types.h are different"
#endif
/* Check if header file and Ftm_Common_Types.h header file are of the same software version */
#if ((PWM_PBCFG_SW_MAJOR_VERSION_C != PWM_FLEXIO_TYPES_SW_MAJOR_VERSION) || \
     (PWM_PBCFG_SW_MINOR_VERSION_C != PWM_FLEXIO_TYPES_SW_MINOR_VERSION) || \
     (PWM_PBCFG_SW_PATCH_VERSION_C != PWM_FLEXIO_TYPES_SW_PATCH_VERSION))
    #error "Software Version Numbers of Pwm_PBcfg.c and Pwm_FlexIO_Types.h are different"
#endif
...
*/
#define PWM_CONF_CHANNELS_PB            ((uint8) 1U)

/** 
* @brief Number of configured Ftm channels 
*/
#define PWM_FTM_MOD_CONFIGS_PB          ((uint8) 1U)

/** 
* @brief Number of configured Ftm channels 
*/
#define PWM_CONF_FTM_CHANNELS_PB         ((uint8) 1U)
...
{
    /* PTA11_LIGHT_PWM - PwmChannelId_0 */
    {
...
static CONST(Pwm_Ftm_ModuleConfigType, PWM_CONST) Pwm_Ftm_ModuleConfig_PB[PWM_FTM_MOD_CONFIGS_PB] =
{
    ...
    /* Ftm Module 0 */
    {
        ...
        /** @brief FTM_1_SC register */
        (FTM_SC_CLKS_SYS_CLOCK_U32 | FTM_SC_PS_DIV128_U32 |  ((uint32)1U << (FTM_SC_PWMOUTPUTEN_SHIFT + (uint32)5U ))| ((uint32)0)),

        
        /** @brief FTM_1_SYNC register */
        (uint8) (FTM_SYNC_CNTMIN_ENABLE_U32 | ((uint32) 0)),
         
        /** @brief FTM_1_MODE register used to enable other features of the FTM */
        (FTM_MODE_INIT_ENABLE_U32 | FTM_MODE_FTMEN_ENABLE_U32 | FTM_MODE_WPDIS_DISABLE_U32 | ((uint32)0)),    
 
        /** @brief FTM_1_DEADTIME register */
        (FTM_DEADTIME_DTPS_DIV1_U32 | ((uint32) 0U)),

        /** @brief FTM_1_COMBINE register */
        (FTM_COMBINE_SYNCEN2_ENABLE_U32 | ((uint32) 0)),
        
         /** @brief Id of the referenced FTM module: FTM_1 */
        PWM_FTM_1,
        
        /** @brief Default period value: , freq = 100.0 Hz: FTM_1_MOD register*/
        ((Pwm_PeriodType) 625)
            
#if (PWM_FAULT_SUPPORTED == STD_ON)
        ,

        /** @brief FTM_1_FLTCTRL register */
        ((uint32) 0),

        /** @brief FTM_1_FLTPOL register */
        ((uint32) 0),
