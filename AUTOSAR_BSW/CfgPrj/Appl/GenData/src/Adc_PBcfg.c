...
* signifiance and case sensitivity are supported for external identifiers
*/
#define ADC_AR_ERLEASE_MINOR_VERSION_PBCFG_C     3
/**
* @violates @ref Adc_PBcfg_C_REF_3 The compiler/linker shall be checked to ensure that 31 character
* signifiance and case sensitivity are supported for external identifiers
*/
#define ADC_AR_RELEASE_REVISION_VERSION_PBCFG_C  1
...
extern void ADC_GR_ADC0_CH5_Cbk(void); /**< @brief for Group - 0 */
/** @violates @ref Adc_PBcfg_C_REF_6 MISRA-C:2004 Rule 8.8: External object declared more than once.*/
extern void ADC_GR_ADC0_CH9_Cbk(void); /**< @brief for Group - 1 */
