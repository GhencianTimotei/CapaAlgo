 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dem_Swc_Types.h
 *   Generation Time: 2022-06-16 15:31:37
 ...
 */
#if !defined (DEM_SWC_TYPES_H)
# define DEM_SWC_TYPES_H
...
/* Here: DEM used without RTE  (DEM_CFG_USE_RTE == STD_OFF) */
#include "Dem_Cdd_Types.h"

#endif  /* DEM_SWC_TYPES_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Swc_Types.h     [Vag (Vector), VARIANT-PRE-COMPILE, 20.06.01.133983]
**********************************************************************************************************************/
