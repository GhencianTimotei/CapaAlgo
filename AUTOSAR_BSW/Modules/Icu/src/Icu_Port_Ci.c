...
*     Autosar ConfVariant : 
*     SWVersion           : 1.0.1
*     BuildVersion        : S32K14x_MCAL_1_0_1_RTM_HF6_ASR_REL_4_3_REV_0001_20210225
* 
...
/** @violates @ref Icu_PORT_CI_c_REF_3 MISRA 2004 Rule 1.4, Identifier clash */
#define ICU_PORT_CI_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref Icu_PORT_CI_c_REF_3 MISRA 2004 Rule 1.4, Identifier clash */
#define ICU_PORT_CI_AR_RELEASE_REVISION_VERSION_C  1
...
*/
CONST(uint32, ICU_CONST) ICU_PORT_CI_BASE_ADDR32[] = 
{
                                                ...
                                                (CONST(Icu_Port_Ci_ChannelType, AUTOMATIC) hwChannel)
{
    ...
    SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_60();
    {
        ...
        if (Icu_Port_Ci_aChActivationMode[hwChannel] == ICU_PORT_CI_CH_FALLING_EDGE_U8)
        {
            ...
            REG_RMW32(ICU_PORT_CI_PCR_ADDR32(u16port,(uint32)u16pin), ICU_PORT_CI_PCR_IREE_U32, (uint32)0U); 
            /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            REG_RMW32(ICU_PORT_CI_PCR_ADDR32(u16port,(uint32)u16pin), ICU_PORT_CI_PCR_IFEE_U32, ICU_PORT_CI_PCR_IFEE_U32);
        }
        else if (Icu_Port_Ci_aChActivationMode[hwChannel] == ICU_PORT_CI_CH_RISING_EDGE_U8)
        {
            /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            REG_RMW32(ICU_PORT_CI_PCR_ADDR32(u16port,(uint32)u16pin), ICU_PORT_CI_PCR_IFEE_U32, (uint32)0U);
            /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            REG_RMW32(ICU_PORT_CI_PCR_ADDR32(u16port,(uint32)u16pin), ICU_PORT_CI_PCR_IREE_U32, ICU_PORT_CI_PCR_IREE_U32);
        }
        else
        {
            /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            REG_RMW32(ICU_PORT_CI_PCR_ADDR32(u16port,(uint32)u16pin), ICU_PORT_CI_PCR_IEEE_U32, ICU_PORT_CI_PCR_IEEE_U32);
        }
        
        /* Clear pending flag */
        /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
        REG_WRITE32(ICU_PORT_CI_ISFR_ADDR32(u16port), u32pinMask);
    }
                                                ...
                                                (CONST(Icu_Port_Ci_ChannelType, AUTOMATIC) hwChannel)
{
    ...
    SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_61();
    {
        /* Disable interrupt */
        /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
        REG_RMW32(ICU_PORT_CI_PCR_ADDR32(u16port,(uint32)u16pin), ICU_PORT_CI_PCR_IRQC_U32, (uint32)0U);
    ...
    SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_61();   
}
...
)
{
    ...
    for (nCounter=0U; nCounter < pPort_CiIpConfig->nNumChannels; nCounter++)
    {
        ...
        /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
        REG_RMW32(ICU_PORT_CI_DFER_ADDR32(u16port), u32pinMask, (uint32)0U);
...
FUNC (boolean, ICU_CODE) Icu_Port_Ci_GetInputState(VAR(Icu_Port_Ci_ChannelType, AUTOMATIC) hwChannel)
{
    ...
    /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
    /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
    CONST(uint32, ICU_CONST) u32RegPort_ciPCR = REG_BIT_GET32(ICU_PORT_CI_PCR_ADDR32(u16port, (uint32)u16pin), ICU_PORT_CI_PCR_IRQC_U32);
    
    /* Get Interrupt Status flag */
    /** @violates @ref Icu_PORT_CI_c_REF_4 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
    /** @violates @ref Icu_PORT_CI_c_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
    CONST(uint32, ICU_CONST) u32RegPort_ciISFR = REG_BIT_GET32(ICU_PORT_CI_ISFR_ADDR32(u16port), u32pinMask);
