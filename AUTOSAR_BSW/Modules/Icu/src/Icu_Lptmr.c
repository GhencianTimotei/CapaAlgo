...
/** @violates @ref ICU_LPTMR_C_REF_4 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define ICU_LPTMR_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref ICU_LPTMR_C_REF_4 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define ICU_LPTMR_AR_RELEASE_REVISION_VERSION_C  1
...
LOCAL_INLINE FUNC(void, ICU_CODE) Icu_Lptmr_EnableInterrupt(void)
{
    SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_32();
    {
        ...
        if (0x0U == REG_BIT_GET32(LPTMR_CSR_ADDR32, LPTMR_CSR_TIE_MASK_U32))
        {
...
)
{
    ...
    u8ClockSource = (uint8)((((*pGlobalConfig) & LPTMR_PSR_PCS_MASK_U32) >> LPTMR_PSR_PCS_SHIFT) << LPTMR_PSR_PCS_SHIFT);
    u8Prescaler   = (uint8)((((*pGlobalConfig) & LPTMR_PSR_PRESCALE_MASK_U32) >> LPTMR_PSR_PRESCALE_SHIFT) << LPTMR_PSR_PRESCALE_SHIFT);
    u8HwChannel   = pLptmrChannelConfig->nHwChannel;
    nCtrlRegVal   = pLptmrChannelConfig->nControlValue;

    u8PinSelect   = (uint8)(((nCtrlRegVal & LPTMR_CSR_TPS_MASK_U32) >> LPTMR_CSR_TPS_SHIFT) << LPTMR_CSR_TPS_SHIFT);
    u8PrescalerEnable    = (uint8)((nCtrlRegVal & LPTMR_PSR_PBYP_MASK_U32) >> LPTMR_PSR_PBYP_SHIFT);
...
#if (ICU_ASREXT_STANDBY_WAKEUP_SUPPORT == STD_ON)
    if (FALSE == ((0x0U != REG_BIT_GET32(LPTMR_CSR_ADDR32, LPTMR_CSR_TCF_MASK_U32)) && \
        (0x0U != REG_BIT_GET32(LPTMR_CSR_ADDR32, LPTMR_CSR_TIE_MASK_U32))))
    {
#endif
    ...
    if (LPTMR_CHANNEL_MODE_EDGE_COUNTER == nChannelMode)
    {
        ...
        /** @violates @ref ICU_LPTMR_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref ICU_LPTMR_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
        REG_RMW32(LPTMR_CSR_ADDR32, LPTMR_CSR_TFC_MASK_U32|LPTMR_CSR_TCF_MASK_U32,LPTMR_CSR_TFC_MASK_U32);
    }
#endif
    ...
    if (LPTMR_CHANNEL_MODE_SIGNAL_EDGE_DETECT == nChannelMode)
    {
        ...
        /** @violates @ref ICU_LPTMR_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref ICU_LPTMR_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
        REG_BIT_CLEAR32(LPTMR_CSR_ADDR32, LPTMR_CSR_TFC_MASK_U32|LPTMR_CSR_TCF_MASK_U32);
    ...
    /** @violates @ref ICU_LPTMR_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
    /** @violates @ref ICU_LPTMR_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
    REG_RMW32(LPTMR_CSR_ADDR32, LPTMR_CSR_TEN_MASK_U32|LPTMR_CSR_TCF_MASK_U32,LPTMR_CSR_TEN_MASK_U32);
...
)
{
    ...
    SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_36();
    {
        if(LPTMR_RISING_EDGE == Activation)
        {
            ...
            /** @violates @ref ICU_LPTMR_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref ICU_LPTMR_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            REG_BIT_CLEAR32(LPTMR_CSR_ADDR32, LPTMR_CSR_TPP_MASK_U32|LPTMR_CSR_TCF_MASK_U32);
        }
        else
        {
            ...
            /** @violates @ref ICU_LPTMR_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
            /** @violates @ref ICU_LPTMR_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
            REG_RMW32(LPTMR_CSR_ADDR32, LPTMR_CSR_TPP_MASK_U32|LPTMR_CSR_TCF_MASK_U32, LPTMR_CSR_TPP_MASK_U32);
        }
    }
