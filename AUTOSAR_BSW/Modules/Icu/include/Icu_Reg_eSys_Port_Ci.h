...
/* @violates @ref Icu_Reg_eSys_PORT_CI_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define ICU_REGESYS_PORT_CI_AR_RELEASE_MINOR_VERSION     3
/* @violates @ref Icu_Reg_eSys_PORT_CI_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define ICU_REGESYS_PORT_CI_AR_RELEASE_REVISION_VERSION  1
...
extern CONST(uint32, ICU_CONST) ICU_PORT_CI_BASE_ADDR32[];
 ...
 */
#define ICU_PORT_CI_ISFR_ADDR32(u8PortIdx)             (ICU_PORT_CI_BASE_ADDR32[(u8PortIdx)] + (uint32)0xA0UL)

/* @brief Pin Control Register address
 * @violates @ref Icu_Reg_eSys_PORT_CI_h_REF_2 Function-like macro defined
 */
#define ICU_PORT_CI_PCR_ADDR32(u8PortIdx, u8PinIdx)    (ICU_PORT_CI_BASE_ADDR32[(u8PortIdx)] + (uint32)((u8PinIdx)<<(2UL)))

/* @brief Interrupt Digital Filter Enable Register address
 * @violates @ref Icu_Reg_eSys_PORT_CI_h_REF_2 Function-like macro defined
 */
#define ICU_PORT_CI_DFER_ADDR32(u8PortIdx)         (ICU_PORT_CI_BASE_ADDR32[(u8PortIdx)] + (uint32)0xC0UL)

/* @brief Interrupt Digital Filter Clock Register address
 * @violates @ref Icu_Reg_eSys_PORT_CI_h_REF_2 Function-like macro defined
 */
#define ICU_PORT_CI_DFCR_ADDR32(u8PortIdx)         (ICU_PORT_CI_BASE_ADDR32[(u8PortIdx)] + (uint32)0xC4UL)

/* @brief Interrupt Digital Filter Width Register address
 * @violates @ref Icu_Reg_eSys_PORT_CI_h_REF_2 Function-like macro defined
 */
#define ICU_PORT_CI_DFWR_ADDR32(u8PortIdx)         (ICU_PORT_CI_BASE_ADDR32[(u8PortIdx)] + (uint32)0xC8UL)

/* @brief Maximum and Minimum Filter Length */
#define ICU_PORT_CI_DFWR_MAXFL_U32                          (0x0000001FUL)
#define ICU_PORT_CI_DFWR_MINFL_U32                          (0x00000000UL)


/* @brief DMA/Interrupt Status flag mask */
#define ICU_PORT_CI_PCR_ISF_U32                             (BIT24)
/* @brief DMA/Interrupt Request rising/falling/either edge masks */
#define ICU_PORT_CI_PCR_IREE_U32                            (BIT19|BIT16)
#define ICU_PORT_CI_PCR_IFEE_U32                            (BIT19|BIT17)
#define ICU_PORT_CI_PCR_IEEE_U32                            (BIT19|BIT17|BIT16)
/* @brief Disable all DMA/Interrupt mask */
#define ICU_PORT_CI_PCR_IRQC_U32                            (BIT19|BIT18|BIT17|BIT16)
