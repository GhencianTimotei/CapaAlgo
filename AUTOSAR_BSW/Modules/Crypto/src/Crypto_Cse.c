...
#define CRYPTO_CSE_SW_PATCH_VERSION_C              1
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
#define CRYPTO_START_NEW_WORD_U8                        ((uint8)4U)
...
/* Represents the number of bits on which the shifting is done for the endianess change  */
...
LOCAL_INLINE FUNC(void, CRYPTO_CODE) Crypto_Cse_WritePagesToPRAM (CONST (uint8, AUTOMATIC) aText[], VAR(uint32, AUTOMATIC) u32Location, VAR(uint16, AUTOMATIC) u16NoPages)
{
    ...
    for ( u8PageIdx = 0U; u8PageIdx < u16NoPages; u8PageIdx++ )
    {
        ...
        for ( u8WordIdx = 0U; CRYPTO_BYTES_ONE_PAGE_U8 > u8WordIdx; u8WordIdx = u8WordIdx + CRYPTO_START_NEW_WORD_U8 )
        {
            ...
            u32IndexLocation = u32IndexLocation + (uint32)CRYPTO_START_NEW_WORD_U8;
        }
    }
}
...
{   
    ...
    for ( u8PageIdx = 0U; u8PageIdx < u16NoPages; u8PageIdx++ )
    {
        for ( u8WordIdx = 0U; CRYPTO_BYTES_ONE_PAGE_U8 > u8WordIdx ; u8WordIdx = u8WordIdx + CRYPTO_START_NEW_WORD_U8 )
        {
            ...
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/         
            aText[u32Index + CRYPTO_FOURTH_BYTE_IN_A_WORD_U32] = REG_READ8(u32PRAMLocation);
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
            aText[u32Index + CRYPTO_THIRD_BYTE_IN_A_WORD_U32] = REG_READ8(u32PRAMLocation + CRYPTO_SECOND_BYTE_IN_A_WORD_U32);
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
            aText[u32Index + CRYPTO_SECOND_BYTE_IN_A_WORD_U32] = REG_READ8(u32PRAMLocation + CRYPTO_THIRD_BYTE_IN_A_WORD_U32);
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
            aText[u32Index] = REG_READ8(u32PRAMLocation + CRYPTO_FOURTH_BYTE_IN_A_WORD_U32);
            u32Index = u32Index + (uint32)CRYPTO_START_NEW_WORD_U8;
        }
    }
}
                                                                       ...
                                                                       )
{
    ...
    if (Crypto_Cse_eState != CRYPTO_CSE_IDLE)
    {
        ...
        {
            u32CommandHeader = (((Crypto_CseCommandWordType)(eKeyID) << CRYPTO_PRAM_HDR_KEYID_U8) | ((Crypto_CseCommandWordType)(eCallSeq) << CRYPTO_PRAM_HDR_SEQ_U8) \
                            | ((Crypto_CseCommandWordType)(eFuncFormat) << CRYPTO_PRAM_HDR_FORMAT_U8) | ((Crypto_CseCommandWordType)(eCmd) << CRYPTO_PRAM_HDR_CMD_U8) 
                                );
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
        ...
        else
        {
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
            REG_WRITE8(CRYPTO_PRAM_HDR_SEQ_ADDR32, (uint8)CRYPTO_CSE_CALL_SEQ_SEQUENT);
        }
...
{   
    ...
    if ( CRYPTO_NO_COMMAND_IN_PROGRESS_U8 == REG_BIT_GET8(CRYPTO_FCSESTAT_ADDR32, CRYPTO_FCSESTAT_BSY_U8) )
    {
        ...
        if (0U == REG_BIT_GET8(CRYPTO_FSTAT_ADDR32, CRYPTO_FSTAT_RDCOLERR_U8 | CRYPTO_FSTAT_ACCERR_U8 | CRYPTO_FSTAT_FPVIOL_U8 | CRYPTO_FSTAT_MGSTAT0_U8))
        {
            /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
            /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
            eOutResponse = (Crypto_Cse_ErrorCodeType)REG_READ16(CRYPTO_PRAM_ERR_ADDR32);
        }
        else
        {
...
FUNC(void, CRYPTO_CODE) Crypto_Cse_FTFCProcessInterrupt (void)
{
    ...
    /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
    /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
    Crypto_Cse_InitState.eOutResponse = (Crypto_Cse_ErrorCodeType)REG_READ16(CRYPTO_PRAM_ERR_ADDR32);
    /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
    /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
...
LOCAL_INLINE FUNC(void, CRYPTO_CODE) Crypto_CseStartEnDeCbc(void)
{
    ...
    if (Crypto_bCseFirstCall)
    {
        ...
        /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
        /** @violates @ref Crypto_Cse_c_REF_8 Violates MISRA 2004 Required Rule 10.1, the value of an expression of integer is converted to a different underlying type */
        REG_WRITE16(CRYPTO_PRAM_PAGE0_LENGTH_SLOT_ADDR16, Crypto_Cse_InitState.num_pages);
...
static FUNC(void, CRYPTO_CODE) Crypto_Cse_ReadMacStatus (P2VAR(Crypto_VerifyResultType, AUTOMATIC, CRYPTO_APPL_DATA) pStatus, VAR(Crypto_Cse_ErrorCodeType, AUTOMATIC) eResponse)
{
    ...
    if ( CRYPTO_CSE_ERC_NO_ERROR == eResponse)
    {
        /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
        /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
        u16ReadStatus = REG_READ16(CRYPTO_PRAM_PAGE1_MAC_STATUS_ADDR16);
...
LOCAL_INLINE FUNC (void, CRYPTO_CODE) Crypto_CseStartVerMacCmd(void)
{
    ...
    if (Crypto_bCseFirstCall)
    {
        ...
        /** @violates @ref Crypto_Cse_c_REF_6 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/ 
        /** @violates @ref Crypto_Cse_c_REF_7 MISRA 2004 Rule 11.3, Cast from unsigned long to pointer*/
        REG_WRITE16(CRYPTO_PRAM_PAGE0_MAC_LENGTH_SLOT_ADDR16, (uint16)(Crypto_Cse_InitState.macLength));
    }
    if (CRYPTO_ALL_AVAILABLE_PRAM_PAGES_U16 < Crypto_Cse_InitState.num_pages)
    {
        Crypto_Cse_WritePagesToPRAM (Crypto_Cse_InitState.inputdata, CRYPTO_PRAM_PAGE1_ADDR32, CRYPTO_ALL_AVAILABLE_PRAM_PAGES_U16);
