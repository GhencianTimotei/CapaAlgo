...
#define CRYPTO_IPW_SW_PATCH_VERSION_C              1
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
static P2VAR (Crypto_JobType, AUTOMATIC, CRYPTO_APPL_DATA) Crypto_pJobInProgress;
...
(
    ...
    P2VAR(Crypto_JobType, AUTOMATIC,  CRYPTO_APPL_DATA) pJob
);
...
LOCAL_INLINE FUNC(Crypto_Cse_ErrorCodeType, CRYPTO_CODE) Crypto_Ipw_MacGenerate ( P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_CONST) pJob)
{
    ...
    if ( *pJob->jobPrimitiveInputOutput.outputLengthPtr >= pJob->jobPrimitiveInfo->primitiveInfo->resultLength )
    {      
        ...
        *pJob->jobPrimitiveInputOutput.outputLengthPtr = pJob->jobPrimitiveInfo->primitiveInfo->resultLength;
        ...
        {  
            ...
            {      
                ...
                {
                    eStatus = Crypto_Cse_MacAsyncGenerate ( (Crypto_Cse_KeyIdType)pJob->cryptoKeyId,pJob->jobPrimitiveInputOutput.inputPtr, pJob->jobPrimitiveInputOutput.inputLength, pJob->jobPrimitiveInputOutput.outputPtr );
                }
                else
                {
                    eStatus = Crypto_Cse_MacGenerate ( (Crypto_Cse_KeyIdType)pJob->cryptoKeyId,pJob->jobPrimitiveInputOutput.inputPtr, pJob->jobPrimitiveInputOutput.inputLength, pJob->jobPrimitiveInputOutput.outputPtr );
                }
            }
        }
        else
...
LOCAL_INLINE FUNC(Crypto_Cse_ErrorCodeType, CRYPTO_CODE) Crypto_Ipw_MacVerify ( P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_CONST) pJob)
{
    ...
    {  
        ...
        if (( (Std_ReturnType)E_OK  == sVerifyKeyElement.eFound ))
        {
            if (CRYPTO_PROCESSING_ASYNC == pJob->jobPrimitiveInfo->processingType)    
            {
                eStatus = Crypto_Cse_MacAsyncVerify ( (Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr, pJob->jobPrimitiveInputOutput.inputLength, \
                                                 pJob->jobPrimitiveInputOutput.secondaryInputLength, pJob->jobPrimitiveInputOutput.secondaryInputPtr, pJob->jobPrimitiveInputOutput.verifyPtr);
            }
            else
            {
                eStatus = Crypto_Cse_MacVerify ( (Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr, pJob->jobPrimitiveInputOutput.inputLength, \
                                                 pJob->jobPrimitiveInputOutput.secondaryInputLength, pJob->jobPrimitiveInputOutput.secondaryInputPtr,pJob->jobPrimitiveInputOutput.verifyPtr);
            }
        }
        else
...
LOCAL_INLINE FUNC(Crypto_Cse_ErrorCodeType, CRYPTO_CODE) Crypto_Ipw_Encrypt ( P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_CONST) pJob)
{
    ...
    if ( *pJob->jobPrimitiveInputOutput.outputLengthPtr >= pJob->jobPrimitiveInputOutput.inputLength)
    {
        *pJob->jobPrimitiveInputOutput.outputLengthPtr = pJob->jobPrimitiveInputOutput.inputLength;
        ...
        switch (pJob->jobPrimitiveInfo->primitiveInfo->algorithm.mode)
        {
            case CRYPTO_ALGOMODE_ECB:
            {
                if (CRYPTO_PROCESSING_ASYNC == pJob->jobPrimitiveInfo->processingType)
                {
                    eStatus = Crypto_Cse_EcbAsyncEncrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                        pJob->jobPrimitiveInputOutput.inputLength,pJob->jobPrimitiveInputOutput.outputPtr);
                }
                else
                {
                    eStatus = Crypto_Cse_EcbEncrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                        pJob->jobPrimitiveInputOutput.inputLength,pJob->jobPrimitiveInputOutput.outputPtr);
                }
            } break;
            case CRYPTO_ALGOMODE_CBC:
            {
                if ( ( (Std_ReturnType)E_OK  == sVerifyKeyElement.eFound ) )
                {
                    if (CRYPTO_PROCESSING_ASYNC == pJob->jobPrimitiveInfo->processingType)
                    {
                        eStatus = Crypto_Cse_CbcAsyncEncrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                            pJob->jobPrimitiveInputOutput.inputLength,Crypto_aKeyElementList[sVerifyKeyElement.u32Counter]->pCryptoElementArray,pJob->jobPrimitiveInputOutput.outputPtr);
                    }
                    else
                    {
                        eStatus = Crypto_Cse_CbcEncrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                            pJob->jobPrimitiveInputOutput.inputLength,Crypto_aKeyElementList[sVerifyKeyElement.u32Counter]->pCryptoElementArray,pJob->jobPrimitiveInputOutput.outputPtr);
                    }
                }
                else
        ...
        *pJob->jobPrimitiveInputOutput.outputLengthPtr = pJob->jobPrimitiveInputOutput.inputLength;
        switch (pJob->jobPrimitiveInfo->primitiveInfo->algorithm.mode)
        {
            case CRYPTO_ALGOMODE_ECB:
            {
                if (CRYPTO_PROCESSING_ASYNC == pJob->jobPrimitiveInfo->processingType)
                {
                    eStatus = Crypto_Cse_EcbAsyncDecrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                        pJob->jobPrimitiveInputOutput.inputLength,pJob->jobPrimitiveInputOutput.outputPtr);
                }
                else
                {
                    eStatus = Crypto_Cse_EcbDecrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                        pJob->jobPrimitiveInputOutput.inputLength,pJob->jobPrimitiveInputOutput.outputPtr);
                }
            } break;
            case CRYPTO_ALGOMODE_CBC:
            {
                if ( ( (Std_ReturnType)E_OK  == sVerifyKeyElement.eFound ) )
                {
                    if (CRYPTO_PROCESSING_ASYNC == pJob->jobPrimitiveInfo->processingType)
                    {
                        eStatus = Crypto_Cse_CbcAsyncDecrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                        pJob->jobPrimitiveInputOutput.inputLength,Crypto_aKeyElementList[sVerifyKeyElement.u32Counter]->pCryptoElementArray,pJob->jobPrimitiveInputOutput.outputPtr);
                    }
                    else
                    {
                        eStatus = Crypto_Cse_CbcDecrypt((Crypto_Cse_KeyIdType)pJob->cryptoKeyId, pJob->jobPrimitiveInputOutput.inputPtr,
                                                        pJob->jobPrimitiveInputOutput.inputLength,Crypto_aKeyElementList[sVerifyKeyElement.u32Counter]->pCryptoElementArray,pJob->jobPrimitiveInputOutput.outputPtr);
                    }
                }
                else
...
{   
    ...
    {
        eStatus = Crypto_Cse_GenerateRnd (pJob->jobPrimitiveInputOutput.outputPtr);
    }
