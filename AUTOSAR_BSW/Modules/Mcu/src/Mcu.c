...
static FUNC(Std_ReturnType, MCU_CODE) Mcu_CheckInitRamSection(VAR( Mcu_RamSectionType, AUTOMATIC) RamSection)
{
    ...
    else
    {
        ...
        /* Check if Ram write size is valid. */
                    ...
                    ( ((*Mcu_pConfigPtr->Mcu_apRamConfig)[Mcu_au8RamConfigIds[RamSection]]).Mcu_RamWriteSize != (Mcu_RamWriteSizeType)1U ) &&
                    ( ((*Mcu_pConfigPtr->Mcu_apRamConfig)[Mcu_au8RamConfigIds[RamSection]]).Mcu_RamWriteSize != (Mcu_RamWriteSizeType)2U ) &&
                    ( ((*Mcu_pConfigPtr->Mcu_apRamConfig)[Mcu_au8RamConfigIds[RamSection]]).Mcu_RamWriteSize != (Mcu_RamWriteSizeType)4U ) &&
                    ( ((*Mcu_pConfigPtr->Mcu_apRamConfig)[Mcu_au8RamConfigIds[RamSection]]).Mcu_RamWriteSize != (Mcu_RamWriteSizeType)8U )
                )
        {
            CheckStatus = (Std_ReturnType)E_NOT_OK;
...
FUNC( Std_ReturnType, MCU_CODE) Mcu_InitRamSection( VAR( Mcu_RamSectionType, AUTOMATIC) RamSection)
{
    ...
    /* Limit of RamCounter. */
    VAR(Mcu_RamSizeType, AUTOMATIC) RamCounterLimit;
...
/* if no ramConfig is defined, the function will do nothing */
        ...
        if((Std_ReturnType)E_OK == (Std_ReturnType)Mcu_CheckInitRamSection(RamSection))
        {
           ...
           if ( (Std_ReturnType)E_OK == RamStatus )
           {
                ...
                for (RamCounter = (Mcu_RamIndexType)0UL; ((RamCounter < RamCounterLimit)&&((Std_ReturnType)E_OK == RamStatus)); ++RamCounter)
                {
                    switch (pRamConfigPtr->Mcu_RamWriteSize)
                    {
                        case (Mcu_RamWriteSizeType)1U:
                            /* @violates @ref Mcu_c_REF_9 Violates MISRA 2004 Advisory Rule 1.2: Undefined behaviour */
                            /* @violates @ref Mcu_c_REF_8 Violates MISRA 2004 Advisory Rule 11.4 , A cast should not be performed*/
                            if ( (uint8) pRamConfigPtr->Mcu_u64RamDefaultValue  != ( *((uint8 (*)[1U]) (pRamConfigPtr->Mcu_pu8RamBaseAddr)) )[RamCounter] )
                            {
                                RamStatus = (Std_ReturnType)E_NOT_OK;
                            }
                            break;
                        ...
                        case (Mcu_RamWriteSizeType)2U:
                            /* @violates @ref Mcu_c_REF_9 Violates MISRA 2004 Advisory Rule 1.2: Undefined behaviour */
                            /* @violates @ref Mcu_c_REF_8 Violates MISRA 2004 Advisory Rule 11.4 , A cast should not be performed*/
                            if ( (uint16) pRamConfigPtr->Mcu_u64RamDefaultValue != ( *((uint16 (*)[1U]) (pRamConfigPtr->Mcu_pu8RamBaseAddr)) )[RamCounter] )
                            {
                                RamStatus = (Std_ReturnType)E_NOT_OK;
                            }
                            break;
                        ...
                        case (Mcu_RamWriteSizeType)4U:
                            /* @violates @ref Mcu_c_REF_9 Violates MISRA 2004 Advisory Rule 1.2: Undefined behaviour */
                            /* @violates @ref Mcu_c_REF_8 Violates MISRA 2004 Advisory Rule 11.4 , A cast should not be performed*/
                            if ( (uint32) pRamConfigPtr->Mcu_u64RamDefaultValue != ( *((uint32 (*)[1U]) (pRamConfigPtr->Mcu_pu8RamBaseAddr)) )[RamCounter] )
                            {
                                RamStatus = (Std_ReturnType)E_NOT_OK;
                            }
                            break;
                        ...
                        case (Mcu_RamWriteSizeType)8U:
                            /* @violates @ref Mcu_c_REF_9 Violates MISRA 2004 Advisory Rule 1.2: Undefined behaviour */
                            /* @violates @ref Mcu_c_REF_8 Violates MISRA 2004 Advisory Rule 11.4 , A cast should not be performed*/
                            if ( (uint64) pRamConfigPtr->Mcu_u64RamDefaultValue != ( *((uint64 (*)[1U]) (pRamConfigPtr->Mcu_pu8RamBaseAddr)) )[RamCounter] )
                            {
                                RamStatus = (Std_ReturnType)E_NOT_OK;
                            }
                            break;
...
* @violates @ref Mcu_c_REF_6 Violates MISRA 2004 Required Rule 8.10, global declaration of function
*/
FUNC( void, MCU_CODE ) Mcu_SRAMRetentionConfig(VAR (Mcu_SRAMRetenConfigType, AUTOMATIC) eSRAMRetenConfig)
{
#if ( MCU_VALIDATE_GLOBAL_CALL == STD_ON )
