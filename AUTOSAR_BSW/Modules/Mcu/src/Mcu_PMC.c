...
/** @violates @ref Mcu_PMC_c_REF_3 MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked ... */
#define MCU_PMC_AR_RELEASE_MINOR_VERSION_C       3
/** @violates @ref Mcu_PMC_c_REF_3 MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked ... */
#define MCU_PMC_AR_RELEASE_REVISION_VERSION_C    1
...
#endif /* #if (defined(MCU_DISABLE_PMC_INIT) && (STD_OFF == MCU_DISABLE_PMC_INIT)) */
