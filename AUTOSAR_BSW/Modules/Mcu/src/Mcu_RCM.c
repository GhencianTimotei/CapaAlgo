...
/** @violates @ref Mcu_RCM_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_RCM_AR_RELEASE_MINOR_VERSION_C       3
/** @violates @ref Mcu_RCM_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_RCM_AR_RELEASE_REVISION_VERSION_C    1
...
/*Check if source file and Reg_eSys_RCM.h are of the same Software version */
    ...
    #if (MCU_RCM_VENDOR_ID_C != MCU_VENDOR_ID)
        #error "Mcu_RCM.c and Mcu.h have different vendor ids"
    #endif
    /* Check if current file and Mcu header file are of the same Autosar version */
    #if ((MCU_RCM_AR_RELEASE_MAJOR_VERSION_C    != MCU_AR_RELEASE_MAJOR_VERSION) || \
         (MCU_RCM_AR_RELEASE_MINOR_VERSION_C    != MCU_AR_RELEASE_MINOR_VERSION) || \
         (MCU_RCM_AR_RELEASE_REVISION_VERSION_C != MCU_AR_RELEASE_REVISION_VERSION) \
        )
        #error "AutoSar Version Numbers of Mcu_RCM.c and Mcu.h are different"
    #endif
    /* Check if current file and Mcu header file are of the same Software version */
    #if ((MCU_RCM_SW_MAJOR_VERSION_C != MCU_SW_MAJOR_VERSION) || \
         (MCU_RCM_SW_MINOR_VERSION_C != MCU_SW_MINOR_VERSION) || \
         (MCU_RCM_SW_PATCH_VERSION_C != MCU_SW_PATCH_VERSION) \
        )
        #error "Software Version Numbers of Mcu_RCM.c and Mcu.h are different"
    #endif
#endif
#endif
...
*/
/** @violates @ref Mcu_RCM_c_REF_5 Global declaration of function */
