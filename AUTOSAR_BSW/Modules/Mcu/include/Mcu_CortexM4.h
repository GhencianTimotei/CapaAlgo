...
/** @violates @ref Mcu_CortexM4_h_REF_4 The compiler/linker shall be checked. */
#define MCU_CORTEXM4_AR_RELEASE_MAJOR_VERSION        4
/** @violates @ref Mcu_CortexM4_h_REF_4 The compiler/linker shall be checked. */
#define MCU_CORTEXM4_AR_RELEASE_MINOR_VERSION        3
/** @violates @ref Mcu_CortexM4_h_REF_4 The compiler/linker shall be checked. */
#define MCU_CORTEXM4_AR_RELEASE_REVISION_VERSION     1
