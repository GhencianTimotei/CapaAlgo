...
/** @violates @ref Mcu_SCG_h_REF_4 The compiler/linker shall be checked. */
#define MCU_SCG_AR_RELEASE_MAJOR_VERSION     4
/** @violates @ref Mcu_SCG_h_REF_4 The compiler/linker shall be checked. */
#define MCU_SCG_AR_RELEASE_MINOR_VERSION     3
/** @violates @ref Mcu_SCG_h_REF_4 The compiler/linker shall be checked. */
#define MCU_SCG_AR_RELEASE_REVISION_VERSION  1
