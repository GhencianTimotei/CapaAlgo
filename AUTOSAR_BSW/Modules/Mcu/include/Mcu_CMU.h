...
/** @violates @ref Mcu_CMU_h_REF_2 The compiler/linker shall be checked. */
#define MCU_CMU_AR_RELEASE_MAJOR_VERSION     4
/** @violates @ref Mcu_CMU_h_REF_2 The compiler/linker shall be checked. */
#define MCU_CMU_AR_RELEASE_MINOR_VERSION     3
/** @violates @ref Mcu_CMU_h_REF_2 The compiler/linker shall be checked. */
#define MCU_CMU_AR_RELEASE_REVISION_VERSION  1
