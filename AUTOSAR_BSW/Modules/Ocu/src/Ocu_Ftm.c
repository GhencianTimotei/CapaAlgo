...
*   significance and case sensitivity are supported for external identifiers. */
/** @violates @ref Ocu_Ftm_C_REF_6 MISRA 2004 Rule 5.1, Identifiers ... more than 31 characters.*/
#define OCU_FTM_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref Ocu_Ftm_C_REF_4 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
/** @violates @ref Ocu_Ftm_C_REF_6 MISRA 2004 Rule 5.1, Identifiers ... more than 31 characters.*/
#define OCU_FTM_AR_RELEASE_REVISION_VERSION_C  1
...
)
{
    ...
    VAR(uint32 ,    AUTOMATIC)          u8ModuleControlValue;  /* Store controled values from channel configured data */
    VAR(uint32 ,    AUTOMATIC)          u32RegSwoctrl; /* Temporary value of SWOCTRL register */
    VAR(uint32 ,    AUTOMATIC)          u32RegSc;      /* Temporary value of SWOCTRL register */
