...
#define FEE_AR_RELEASE_MINOR_VERSION_C       3
#define FEE_AR_RELEASE_REVISION_VERSION_C    1
...
FUNC( void, FEE_CODE ) Fee_Init(P2CONST( Fee_ConfigType, AUTOMATIC, FEE_APPL_CONST ) paConfigPtr)
{
   VAR( uint32, AUTOMATIC ) uInvalIndex = 0U;
    ...
    {
        /** @violates @ref Fee_c_REF_16 Violates MISRA 2004 Rule 16.10 **/
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_INIT_ID, FEE_E_BUSY );
    }
...
FUNC( void, FEE_CODE ) Fee_SetMode( VAR( MemIf_ModeType, AUTOMATIC) eMode )
{
    ...
    {
        /** @violates @ref Fee_c_REF_16 Violates MISRA 2004 Rule 16.10 **/
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_SETMODE_ID, FEE_E_BUSY );
    }
    else if( MEMIF_BUSY_INTERNAL == Fee_eModuleStatus )
    {
        /** @violates @ref Fee_c_REF_16 Violates MISRA 2004 Rule 16.10 **/
...
#if (FEE_DEV_ERROR_DETECT == STD_ON)
        /** @violates @ref Fee_c_REF_16 Violates MISRA 2004 Rule 16.10 **/
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_READ_ID, FEE_E_BUSY );
#endif    /* FEE_DEV_ERROR_DETECT == STD_ON */
        uRetVal = (Std_ReturnType)E_NOT_OK;
    }
    else if( MEMIF_BUSY_INTERNAL == Fee_eModuleStatus )
...
#if (FEE_DEV_ERROR_DETECT == STD_ON)
        /** @violates @ref Fee_c_REF_16 Violates MISRA 2004 Rule 16.10 **/
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_WRITE_ID, FEE_E_BUSY );
#endif    /* FEE_DEV_ERROR_DETECT == STD_ON */
        uRetVal = (Std_ReturnType)E_NOT_OK;
    }
#if (FEE_DEV_ERROR_DETECT == STD_ON)
...
*               driver.
* @details      The function Fee_Cancel and the cancel function of the underlying 
*               flash driver are from their behaviour synchronous functions 
*               but they are asynchronous w.r.t. an ongoing read, erase or write 
*               job in the flash memory.
*
...
/* If FEE_CANCEL_API == STD_OFF Fee_Cancel set only a Det Error Notification
   Note: this is to avoid robustness issues (in term of internal variables) */
    ...
    else
    {
        ...
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_CANCEL_ID, FEE_E_INVALID_CANCEL );
    #endif    /* FEE_DEV_ERROR_DETECT == STD_ON */
                /* Call job error notification function */
                FEE_NVM_JOB_ERROR_NOTIFICATION
            }
...
FUNC( Std_ReturnType, FEE_CODE ) Fee_InvalidateBlock( VAR( uint16, AUTOMATIC ) uBlockNumber )
{
    ...
    else if( MEMIF_BUSY == Fee_eModuleStatus )
    {
        ...
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_INVALIDATEBLOCK_ID, FEE_E_BUSY );
    }
    else if( MEMIF_BUSY_INTERNAL == Fee_eModuleStatus )
    {
        /** @violates @ref Fee_c_REF_16 Violates MISRA 2004 Rule 16.10 **/
...
FUNC( Std_ReturnType, FEE_CODE ) Fee_EraseImmediateBlock( VAR( uint16, AUTOMATIC ) uBlockNumber )
{
    ...
    else if( MEMIF_BUSY == Fee_eModuleStatus )
    {
        ...
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_ERASEIMMEDIATEBLOCK_ID, FEE_E_BUSY );
        uRetVal = (Std_ReturnType)E_NOT_OK;
    }
    else if( MEMIF_BUSY_INTERNAL == Fee_eModuleStatus )
    {
    ...
    )
{
    ...
    */
    ...
    else if( MEMIF_BUSY == Fee_eModuleStatus )
    {
        ...
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_GETRUNTIMEINFO_ID, FEE_E_BUSY );
#endif    /* FEE_DEV_ERROR_DETECT == STD_ON */
    }
#if (FEE_DEV_ERROR_DETECT == STD_ON)
    else if( MEMIF_BUSY_INTERNAL == Fee_eModuleStatus )
...
FUNC( Std_ReturnType, FEE_CODE ) Fee_ForceSwapOnNextWrite ( VAR( uint8, AUTOMATIC ) uClrGrpIndex )
{
    ...
    */
    ...
    else if( MEMIF_BUSY == Fee_eModuleStatus )
    {
        ...
        Det_ReportRuntimeError( (uint16)FEE_MODULE_ID, FEE_INSTANCE_ID, FEE_FORCESWAPONNEXTWRITE_ID, FEE_E_BUSY );
#endif    /* FEE_DEV_ERROR_DETECT == STD_ON */
        uRetVal = (Std_ReturnType)E_NOT_OK;
    }
#if (FEE_DEV_ERROR_DETECT == STD_ON)
