...
/** @violates @ref Dio_Gpio_h_REF_2 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define DIO_GPIO_AR_RELEASE_MAJOR_VERSION      4
/** @violates @ref Dio_Gpio_h_REF_2 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define DIO_GPIO_AR_RELEASE_MINOR_VERSION      3
/** @violates @ref Dio_Gpio_h_REF_2 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define DIO_GPIO_AR_RELEASE_REVISION_VERSION   1
