...
/** @violates @ref GPT_FTM_C_REF_4 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define GPT_FTM_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref GPT_FTM_C_REF_4 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define GPT_FTM_AR_RELEASE_REVISION_VERSION_C  1
...
#if (GPT_FTM_VENDOR_ID_C != GPT_FTM_TYPES_VENDOR_ID)
    #error "Gpt_Ftm.c and Gpt_Ftm_Types.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
#if ((GPT_FTM_AR_RELEASE_MAJOR_VERSION_C != GPT_FTM_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (GPT_FTM_AR_RELEASE_MINOR_VERSION_C != GPT_FTM_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (GPT_FTM_AR_RELEASE_REVISION_VERSION_C != GPT_FTM_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Gpt_Ftm.c and Gpt_Ftm_Types.h are different"
#endif
/* Check if the header files are of the same Software version */
#if ((GPT_FTM_SW_MAJOR_VERSION_C != GPT_FTM_TYPES_SW_MAJOR_VERSION) || \
     (GPT_FTM_SW_MINOR_VERSION_C != GPT_FTM_TYPES_SW_MINOR_VERSION) || \
     (GPT_FTM_SW_PATCH_VERSION_C != GPT_FTM_TYPES_SW_PATCH_VERSION))
    #error "Software Version Numbers of Gpt_Ftm.c and Gpt_Ftm_Types.h are different"
#endif
/*==================================================================================================
                                                ...
                                                )
{
    ...
    /** @violates @ref GPT_FTM_C_REF_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long to pointer.*/
    /** @violates @ref GPT_FTM_C_REF_7 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/
                                                 ...
                                                 P2VAR(uint32, AUTOMATIC, GPT_APPL_DATA) pu32TargetValue)
{
    ...
    *pu32TargetValue = Gpt_Ftm_u32TargetValue[u8ModuleIdx][u8ChannelIdx];
    ...
    if (u32CounterValue > u32CompareValue)
    {
        ...
        if(((FTM_CNT_MAX_VALUE_U32 - u32CounterValue) + u32CompareValue) <= *pu32TargetValue)
        {
            /* New compare value was read by register read - isr served in time - we have roll-over */
            u32ReturnValue = (*pu32TargetValue - \
                            ((FTM_CNT_MAX_VALUE_U32 - u32CounterValue) + u32CompareValue)) + \
