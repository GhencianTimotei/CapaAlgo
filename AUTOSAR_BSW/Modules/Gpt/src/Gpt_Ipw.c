...
/** @violates @ref GPT_IPW_C_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define GPT_IPW_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref GPT_IPW_C_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define GPT_IPW_AR_RELEASE_REVISION_VERSION_C  1
...
#if (GPT_IPW_VENDOR_ID_C != GPT_SRTC_VENDOR_ID)
    #error "Gpt_Ipw.c and Gpt_SRtc.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
#if ((GPT_IPW_AR_RELEASE_MAJOR_VERSION_C != GPT_SRTC_AR_RELEASE_MAJOR_VERSION) || \
     (GPT_IPW_AR_RELEASE_MINOR_VERSION_C != GPT_SRTC_AR_RELEASE_MINOR_VERSION) || \
     (GPT_IPW_AR_RELEASE_REVISION_VERSION_C != GPT_SRTC_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Gpt_Ipw.c and Gpt_SRtc.h are different"
#endif
/* Check if the header files are of the same Software version */
#if ((GPT_IPW_SW_MAJOR_VERSION_C != GPT_SRTC_SW_MAJOR_VERSION) || \
     (GPT_IPW_SW_MINOR_VERSION_C != GPT_SRTC_SW_MINOR_VERSION) || \
     (GPT_IPW_SW_PATCH_VERSION_C != GPT_SRTC_SW_PATCH_VERSION))
    #error "Software Version Numbers of Gpt_Ipw.c and Gpt_SRtc.h are different"
#endif
/*==================================================================================================
...
*
* @param[in]     pHwChannelConfig       Pointer to the channel configuration structure dependent by platform
* @param[in]     pReturnHwChannelInfo   Hw channel info
*
*/
