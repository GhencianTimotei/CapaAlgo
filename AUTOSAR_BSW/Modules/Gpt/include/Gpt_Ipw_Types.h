...
#define GPT_IPW_TYPES_AR_RELEASE_MINOR_VERSION       3
#define GPT_IPW_TYPES_AR_RELEASE_REVISION_VERSION    1
...
#if (GPT_IPW_TYPES_VENDOR_ID != GPT_SRTC_TYPES_VENDOR_ID)
    #error "Gpt_Ipw_Tyes.h and Gpt_SRtc_Types.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
#if ((GPT_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != GPT_SRTC_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (GPT_IPW_TYPES_AR_RELEASE_MINOR_VERSION != GPT_SRTC_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (GPT_IPW_TYPES_AR_RELEASE_REVISION_VERSION != GPT_SRTC_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Gpt_Ipw_Tyes.h and Gpt_SRtc_Types.h are different"
#endif
/* Check if the header files are of the same Software version */
#if ((GPT_IPW_TYPES_SW_MAJOR_VERSION != GPT_SRTC_TYPES_SW_MAJOR_VERSION) || \
     (GPT_IPW_TYPES_SW_MINOR_VERSION != GPT_SRTC_TYPES_SW_MINOR_VERSION) || \
     (GPT_IPW_TYPES_SW_PATCH_VERSION != GPT_SRTC_TYPES_SW_PATCH_VERSION))
    #error "Software Version Numbers of Gpt_Ipw_Tyes.h and Gpt_SRtc_Types.h are different"
#endif
/*==================================================================================================
*                                           CONSTANTS
==================================================================================================*/
