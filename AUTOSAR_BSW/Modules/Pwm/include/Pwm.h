...
/* @violates @ref Pwm_H_REF_3 Identifier clash. */
#define PWM_AR_RELEASE_REVISION_VERSION     1
...
/**
* @brief            Generated when Module not support set output to idle
*                   
* @details          
* @implements       Pwm_ErrorIds_define Non-AUTOSAR
*/
#define PWM_E_SETOUTPUTTOIDLE_NOT_SUPPORT                (0x3EU)
/**
