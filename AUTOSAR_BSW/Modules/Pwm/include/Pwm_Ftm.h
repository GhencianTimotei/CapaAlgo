...
/*
* @violates @ref Pwm_Ftm_H_REF_3 Identifier clash.
*/
...
*/
/* @violates @ref Pwm_Ftm_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_FTM_AR_RELEASE_MINOR_VERSION          3
/*
* @violates @ref Pwm_Ftm_H_REF_3 Identifier clash.
*/
/* @violates @ref Pwm_Ftm_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_FTM_AR_RELEASE_REVISION_VERSION       1
