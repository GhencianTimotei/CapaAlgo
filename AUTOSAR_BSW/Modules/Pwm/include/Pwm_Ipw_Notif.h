...
/* @violates @ref Pwm_IPW_Notif_H_REF_3 Identifier exceeds 31 chars. */
#define PWM_IPW_NOTIF_AR_RELEASE_MINOR_VERSION        3
/* @violates @ref Pwm_IPW_Notif_H_REF_3 Identifier exceeds 31 chars. */
#define PWM_IPW_NOTIF_AR_RELEASE_REVISION_VERSION     1
...
/* @violates @ref Pwm_IPW_Notif_H_REF_3 Identifier exceeds 31 chars. */
/* @violates @ref Pwm_IPW_Notif_H_REF_4 Function like macro. */
#define Pwm_Ipw_FtmChannelNotification(Channel)  Pwm_Notification((Pwm_ChannelType)(Channel) + IDX_FIRST_FTM_CH_IN_HW_REVERSE_MAP)
#endif

#if (PWM_FLEXIO_USED == STD_ON)   

/* Function for notifications of FlexIO channels implemented through macro */
/* @violates @ref Pwm_Ipw_Notif_h_REF_1 Function like macro are used to reduce code complexity. */
/*
* @violates @ref Pwm_IPW_Notif_H_REF_2 A function should be used in preference to a 
*  function-like  macro.
*/
/* @violates @ref Pwm_IPW_Notif_H_REF_4 Function like macro. */
#define Pwm_Ipw_FlexIOChannelNotification(Channel)  Pwm_Notification((Pwm_ChannelType)(Channel) + IDX_FIRST_FLEXIO_CH_IN_HW_REVERSE_MAP)
