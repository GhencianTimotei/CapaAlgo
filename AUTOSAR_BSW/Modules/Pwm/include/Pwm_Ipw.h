...
/*
* @violates @ref Pwm_IPW_H_REF_5 Identifier clash.
*/
...
*/
/* @violates @ref Pwm_IPW_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_IPW_AR_RELEASE_MINOR_VERSION          3
/*
* @violates @ref Pwm_IPW_H_REF_5 Identifier clash.
*/
/* @violates @ref Pwm_IPW_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_IPW_AR_RELEASE_REVISION_VERSION       1
...
/* Check if header file and Pwm_Ftm header file are of the same vendor */
#if (PWM_IPW_VENDOR_ID != PWM_FTM_VENDOR_ID)
    #error "Pwm_Ipw.h and Pwm_Ftm.h have different vendor ids"
#endif

/* Check if header file and Pwm_Ftm header file are of the same Autosar version */
#if ((PWM_IPW_AR_RELEASE_MAJOR_VERSION    != PWM_FTM_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_IPW_AR_RELEASE_MINOR_VERSION    != PWM_FTM_AR_RELEASE_MINOR_VERSION) || \
     (PWM_IPW_AR_RELEASE_REVISION_VERSION != PWM_FTM_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Pwm_Ipw.h and Pwm_Ftm.h are different"
#endif

/* Check if header file and Pwm_Ftm header file are of the same software version */
#if ((PWM_IPW_SW_MAJOR_VERSION != PWM_FTM_SW_MAJOR_VERSION) || \
     (PWM_IPW_SW_MINOR_VERSION != PWM_FTM_SW_MINOR_VERSION) || \
     (PWM_IPW_SW_PATCH_VERSION != PWM_FTM_SW_PATCH_VERSION))
    #error "Software Version Numbers of Pwm_Ipw.h and Pwm_Ftm.h are different"
#endif
/*===============================================================================================
*                                           CONSTANTS
===============================================================================================*/
