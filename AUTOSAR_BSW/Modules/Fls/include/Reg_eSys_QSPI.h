...
#define ESYS_QSPI_AR_RELEASE_MINOR_VERSION            3
#define ESYS_QSPI_AR_RELEASE_REVISION_VERSION         1
...
#define QSPI_MCR_DDR_EN_SHIFT_U32               (7U)                    /* DDR_EN position shift. */
#define QSPI_MCR_DQS_EN_U32                     ((uint32)0x00000040UL)  /* DQS_EN - DQS enable.             QSPI_MCR[6] */
#define QSPI_MCR_DQS_EN_SHIFT_U32               (6U)                    /* DQS_EN position shift. */
#define QSPI_MCR_DQS_LAT_EN_U32                 ((uint32)0x00000020UL)  /* DQS_LAT_EN - DQS Latency enable. QSPI_MCR[5] */
#define QSPI_MCR_DQS_LAT_EN_SHIFT_U32           (5U)                    /* DQS_LAT_EN position shift. */
...
#define QSPI_MCR_PADS_BUF_EN_SHIFT_U32          (31U)                   /* SCLKCFG[7] position shift. */
...
#define QSPI_MCR_INPUT_CLK_SEL_SHIFT_U32        (30U)                   /* SCLKCFG[6] position shift. */
...
#define QSPI_MCR_INTERN_REF_CLK_SEL_SHIFT_U32   (28U)                   /* SCLKCFG[4] position shift. */
...
#define QSPI_MCR_DQS_B_STAGE2_CLK_SRC_SHIFT_U32 (27U)                   /* SCLKCFG[3] position shift. */
...
#define QSPI_MCR_DQS_B_STAGE1_CLK_SRC_SHIFT_U32 (26U)                   /* SCLKCFG[2] position shift. */
...
#define QSPI_MCR_DQS_A_STAGE2_CLK_SRC_SHIFT_U32 (25U)                   /* SCLKCFG[1] position shift. */
...
#define QSPI_MCR_DQS_A_STAGE1_CLK_SRC_SHIFT_U32 (24U)                   /* SCLKCFG[0] position shift. */

#define QSPI_MCR_ISD3FB_U32                     ((uint32)0x00080000UL)  /* Idle Signal Drive IOFB[3] Flash B. */
#define QSPI_MCR_ISD3FB_SHIFT_U32               (19U)                   /* Idle Signal Drive IOFB[3] Flash B position shift. */
#define QSPI_MCR_ISD2FB_U32                     ((uint32)0x00040000UL)  /* Idle Signal Drive IOFB[2] Flash B. */
#define QSPI_MCR_ISD2FB_SHIFT_U32               (18U)                   /* Idle Signal Drive IOFB[2] Flash B position shift. */
#define QSPI_MCR_ISD3FA_U32                     ((uint32)0x00020000UL)  /* Idle Signal Drive IOFA[3] Flash A. */
#define QSPI_MCR_ISD3FA_SHIFT_U32               (17U)                   /* Idle Signal Drive IOFB[3] Flash A position shift. */
#define QSPI_MCR_ISD2FA_U32                     ((uint32)0x00010000UL)  /* Idle Signal Drive IOFA[2] Flash A. */
#define QSPI_MCR_ISD2FA_SHIFT_U32               (16U)                   /* Idle Signal Drive IOFB[2] Flash A position shift. */
...
#define QSPI_SMPR_FSPHS_SHIFT_U32               (5U)                    /* FSPHS position shift */
...
#define QSPI_SMPR_FSDLY_SHIFT_U32               (6U)                    /* FSDLY position shift */
...
#define QSPI_RBCT_RXBRD_MASK_U32                ((uint32)0x100UL)       /* RXBRD - RX Buffer Readout*/
#define QSPI_RBCT_RXBRD_SHIFT_U32               (8U)                    /* RXBRD position shift*/
#define QSPI_RBCT_WMRK_MASK_U32                 ((uint32)0x0000001FUL)  /* RBCT[4:0] - WMRK bitifield mask. */
#define QSPI_RBCT_WMRK_SHIFT_U32                (0U)                    /* RBCT[4:0] - WMRK bitifield position shift. */
...
#define QSPI_SOCCR_PENDIG_READ_GASKET_SHIFT_U32 (16U)                   /* SOCCFG[16] positon shift. */
...
#define QSPI_SOCCR_BURST_READ_GASKET_SHIFT_U32  (17U)                   /* SOCCFG[17] positon shift. */
...
#define QSPI_SOCCR_BURST_WRITE_GASKET_SHIFT_U32 (18U)                   /* SOCCFG[18] positon shift. */
...
#define QSPI_BUF3CR_ALLMST_SHIFT_U32            (31U)                   /* BUF3CR[31] - All master enable position shift */
#define QSPI_BUF0CR_HP_EN_MASK_U32              ((uint32)0x80000000UL)  /* BUF0CR[31] - High Priority Enable*/
#define QSPI_BUF0CR_HP_EN_SHIFT_U32             (31U)                   /* BUF0CR[31] - High Priority Enable*/
...
/* Integration specific. IPGEF is not exist on this platform. define as 0U (does not impact to FR register) */
#define QSPI_FR_IPGEF_U32                       ((uint32)0x00000000UL)  /* FR[4] IP Command Trigger during AHB Grant Error Flag. */
...
/* Integration specific. IPGEF is not exist on this platform. define as 0U (does not impact to RSER register) */
#define QSPI_RSER_IPGEIE_U32                    ((uint32)0x00000000UL)  /* RSER[4]  IP Command Trigger during AHB Grant Error Interrupt Enable. */
...
#define QSPI_SFACR_WA_SHIFT_U32                 (16U)                   /* SFACR[16] WA bit position shift. */
