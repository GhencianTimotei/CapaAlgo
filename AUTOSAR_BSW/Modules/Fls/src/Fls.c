...
* to ensure that 31 character significance and case sensitivity are supported for external identifiers
*/
#define FLS_AR_RELEASE_MINOR_VERSION_C       3
/*
* @violates @ref fls_c_REF_10 The compiler/linker shall be checked
* to ensure that 31 character significance and case sensitivity are supported for external identifiers
*/
#define FLS_AR_RELEASE_REVISION_VERSION_C    1
...
/* Check if current file and Dem header file are of the same Autosar version */
     ...
     (FLS_AR_RELEASE_REVISION_VERSION_C != FLS_QSPI_AR_RELEASE_REVISION_VERSION_H))
...
/* Check if current file and Fls_Flash.h header file are of the same Autosar version */
     ...
     (FLS_AR_RELEASE_REVISION_VERSION_C != FLS_FLASH_AR_RELEASE_REVISION_VERSION))
    ...
    else
    {
        ...
        else if( FLASH_E_FAILED == eLldRetVal )
        {
            eRetVal = MEMIF_JOB_FAILED;
                                /* @violates @ref fls_c_REF_17 All macro identifers in preprocessor directives shall be defned before use */
