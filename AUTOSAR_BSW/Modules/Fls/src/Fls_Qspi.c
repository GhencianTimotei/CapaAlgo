...
#define FLS_QSPI_AR_RELEASE_MINOR_VERSION_C            3
#define FLS_QSPI_AR_RELEASE_REVISION_VERSION_C         1
...
/* Check if current file and Fls.h header file have the same Vendor ID */
    ...
    #error "Fls_Qspi.c and Fls.h have different vendor ids"
#endif
/* Check if current file and Fls.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Fls_Qspi.c and Fls.h are different"
#endif
...
/* Check if current file and Fls.h header file are of the same Autosar version */
     ...
     (FLS_QSPI_AR_RELEASE_REVISION_VERSION_C != FLS_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Fls_Qspi.c and Fls.h are different"
#endif

/* Check if current file and Reg_eSys_QSPI.h header file have the same Vendor ID */
#if (FLS_QSPI_VENDOR_ID_C != ESYS_QSPI_VENDOR_ID)
    #error "Fls_Qspi.c and Reg_eSys_QSPI.h have different vendor ids"
#endif
...
/* Check if current file and Reg_eSys_QSPI.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Fls_Qspi.c and Reg_eSys_QSPI.h are different"
#endif
...
/* Check if current file and Reg_eSys_QSPI.h header file are of the same Autosar version */
     ...
     (FLS_QSPI_AR_RELEASE_REVISION_VERSION_C != ESYS_QSPI_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Fls_Qspi.c and Reg_eSys_QSPI.h are different"
#endif

/* Check if current file and Fls_Qspi.h header file have the same Vendor ID */
#if (FLS_QSPI_VENDOR_ID_C != FLS_QSPI_VENDOR_ID_H)
    #error "Fls_Qspi.c and Fls_Qspi.h have different vendor ids"
#endif
...
/* Check if current file and Fls_Qspi.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Fls_Qspi.c and Fls_Qspi.h are different"
#endif
...
/* Check if current file and Fls_Qspi.h header file are of the same Autosar version */
     ...
     (FLS_QSPI_AR_RELEASE_REVISION_VERSION_C != FLS_QSPI_AR_RELEASE_REVISION_VERSION_H))
    #error "AutoSar Version Numbers of Fls_Qspi.c and Fls_Qspi.h are different"
#endif
...
/* Check if current file and Fls_Qspi_Types.h header file have the same Vendor ID */
    ...
    #error "Fls_Qspi.c and Fls_Qspi_Types.h have different vendor ids"
#endif
/* Check if current file and Fls_Qspi_Types.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Fls_Qspi.c and Fls_Qspi_Types.h are different"
#endif
...
/* Check if current file and Fls_Qspi_Types.h header file are of the same Autosar version */
     ...
     (FLS_QSPI_AR_RELEASE_REVISION_VERSION_C != FLS_QSPI_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Fls_Qspi.c and Fls_Qspi_Types.h are different"
#endif
    ...
    /* Check if current file and StdRegMacros.h header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Fls_Qspi.c and StdRegMacros.h are different"
    #endif
#endif
    ...
    /* Check if current file and Det header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Fls_Qspi.c and Det.h are different"
    #endif
#endif
#endif
    ...
    /* Check if current file and Mcl header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Fls_Qspi.c and Mcl.h are different"
    #endif
#endif
#endif /* FLS_SYNCRONIZE_CACHE */
/*==================================================================================================
...
static FUNC(Fls_LLDReturnType, FLS_CODE) Fls_Qspi_IPRead_SYNCMode
(
...
static FUNC(Fls_LLDReturnType, FLS_CODE) Fls_Qspi_IPRead_IRQMode
(
    VAR(Fls_AddressType, AUTOMATIC) u32StartAddr,
    VAR(Fls_LengthType, AUTOMATIC) u32DataLength,
    P2VAR(uint8, AUTOMATIC, FLS_APPL_DATA) p8DataReadPtr,
...
{    
    ...
    for( u8Iter = 0U; u8Iter < Fls_pConfigPtr->pFlsQspiCfgConfig->u8QspiUnitsCount; u8Iter++ )
    {
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DDR_EN_U32, \
                   QSPI_MCR_DDR_EN_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitReadMode) << QSPI_MCR_DDR_EN_SHIFT_U32)) \
                 );


        /* Configure DQS mode. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DQS_EN_U32, \
                   QSPI_MCR_DQS_EN_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitDqsMode) << QSPI_MCR_DQS_EN_SHIFT_U32)) \
                 );

        /* Configure input buffers(SCLKCFG[7]). */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_PADS_BUF_EN_U32, 
                   QSPI_MCR_PADS_BUF_EN_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitInputPadsBufferEn) << QSPI_MCR_PADS_BUF_EN_SHIFT_U32)) \
                 );

        /* Configure module clock source(SCLKCFG[6]). */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_INPUT_CLK_SEL_U32, \
                   QSPI_MCR_INPUT_CLK_SEL_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitInputClockSel) << QSPI_MCR_INPUT_CLK_SEL_SHIFT_U32)) \
                 );
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_INTERN_REF_CLK_SEL_U32, \
                   QSPI_MCR_INTERN_REF_CLK_SEL_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitInternalRefClockSel) << QSPI_MCR_INTERN_REF_CLK_SEL_SHIFT_U32)) \
                 );
        /* Configure the reference clock source for DQS for Flash-B Stage 2(SCLKCFG[3]). */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DQS_B_STAGE2_CLK_SRC_U32, \
                   QSPI_MCR_DQS_B_STAGE2_CLK_SRC_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitDqsBStage2ClkSource) << QSPI_MCR_DQS_B_STAGE2_CLK_SRC_SHIFT_U32)) \
                 );
        /* Configure the reference clock source for DQS for Flash-B Stage 1(SCLKCFG[2]). */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DQS_B_STAGE1_CLK_SRC_U32, \
                   QSPI_MCR_DQS_B_STAGE1_CLK_SRC_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitDqsBStage1ClkSource) << QSPI_MCR_DQS_B_STAGE1_CLK_SRC_SHIFT_U32)) \
                 );
        /* Configure the reference clock source for DQS for Flash-A Stage 2(SCLKCFG[1]). */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DQS_A_STAGE2_CLK_SRC_U32, \
                   QSPI_MCR_DQS_A_STAGE2_CLK_SRC_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitDqsAStage2ClkSource) << QSPI_MCR_DQS_A_STAGE2_CLK_SRC_SHIFT_U32)) \
                 );
        /* Configure the reference clock source for DQS for Flash-A Stage 1(SCLKCFG[0]). */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DQS_A_STAGE1_CLK_SRC_U32, \
                   QSPI_MCR_DQS_A_STAGE1_CLK_SRC_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitDqsAStage1ClkSource) << QSPI_MCR_DQS_A_STAGE1_CLK_SRC_SHIFT_U32)) \
                 );

        /* Configure Pending Read Bus Gasket. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_SOCCR_OFFSET_U32, QSPI_SOCCR_PENDIG_READ_GASKET_U32, \
                   QSPI_SOCCR_PENDIG_READ_GASKET_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitPendingReadBusGasket) << QSPI_SOCCR_PENDIG_READ_GASKET_SHIFT_U32)) \
                 );
        /* Configure Burst Read Bus Gasket. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_SOCCR_OFFSET_U32, QSPI_SOCCR_BURST_READ_GASKET_U32, \
                   QSPI_SOCCR_BURST_READ_GASKET_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitBurstReadBusGasket) << QSPI_SOCCR_BURST_READ_GASKET_SHIFT_U32)) \
                 );
        /* Configure Burst Write Bus Gasket. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_SOCCR_OFFSET_U32, QSPI_SOCCR_BURST_WRITE_GASKET_U32, \
                   QSPI_SOCCR_BURST_WRITE_GASKET_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitBurstWriteBusGasket) << QSPI_SOCCR_BURST_WRITE_GASKET_SHIFT_U32)) \
                 );
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_ISD3FB_U32, \
                   QSPI_MCR_ISD3FB_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitIOFB3HighLvl) << QSPI_MCR_ISD3FB_SHIFT_U32)) \
                 );

        /* Configure Idle Signal Drive IOFB[2] Flash B. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_ISD2FB_U32, \
                   QSPI_MCR_ISD2FB_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitIOFB2HighLvl) << QSPI_MCR_ISD2FB_SHIFT_U32)) \
                 );

        /* Configure Idle Signal Drive IOFA[3] Flash A. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_ISD3FA_U32, \
                   QSPI_MCR_ISD3FA_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitIOFA3HighLvl) << QSPI_MCR_ISD3FA_SHIFT_U32)) \
                 );

        /* Configure Idle Signal Drive IOFA[2] Flash A. */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_ISD2FA_U32, \
                   QSPI_MCR_ISD2FA_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitIOFA2HighLvl) << QSPI_MCR_ISD2FA_SHIFT_U32)) \
                 );


        /* Configure sampling edge.(Applicable in SDR mode only.) */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_SMPR_OFFSET_U32, QSPI_SMPR_FSPHS_U32, \
                   QSPI_SMPR_FSPHS_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitSamplingEdge) << QSPI_SMPR_FSPHS_SHIFT_U32)) \
                 );

        /* Configure the sampling delay.(Applicable in SDR mode only.)*/
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_SMPR_OFFSET_U32, QSPI_SMPR_FSDLY_U32, \
                   QSPI_SMPR_FSDLY_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitSamplingDly) << QSPI_SMPR_FSDLY_SHIFT_U32)) \
                 );
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_MCR_OFFSET_U32, QSPI_MCR_DQS_LAT_EN_U32, \
                   QSPI_MCR_DQS_LAT_EN_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitDqsLatencyEn) << QSPI_MCR_DQS_LAT_EN_SHIFT_U32)) \
                 );
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_RBCT_OFFSET_U32, QSPI_RBCT_RXBRD_MASK_U32, \
                   QSPI_RBCT_RXBRD_MASK_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].eQspiUnitRxBufferAccessMode) << QSPI_RBCT_RXBRD_SHIFT_U32)) \
                 );
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_BUF3CR_OFFSET_U32, QSPI_BUF3CR_ALLMST_MASK_U32, \
                   QSPI_BUF3CR_ALLMST_MASK_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bHwUnitAhbBufferAllMasters) << QSPI_BUF3CR_ALLMST_SHIFT_U32)) \
                 );

        /* Set HP_EN bit - enable high priority for  AHB_BUFFER_0 */
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_BUF0CR_OFFSET_U32, QSPI_BUF0CR_HP_EN_MASK_U32, \
                   QSPI_BUF0CR_HP_EN_MASK_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bHwUnitAhbBufferHighPriority) << QSPI_BUF0CR_HP_EN_SHIFT_U32)) \
                 );
        ...
        REG_RMW32( u32ExtHwUnitBaseAddr + QSPI_SFACR_OFFSET_U32, QSPI_SFACR_WA_U32, \
                   QSPI_SFACR_WA_U32 & ((uint32)((uint32)((*(Fls_pConfigPtr->pFlsQspiCfgConfig->paQspiUnitCfg))[u8Iter].bQspiUnitWordAddressable) << QSPI_BUF0CR_HP_EN_SHIFT_U32)) \
                 );
        /* Populate LUT. */
...
)
{
    ...
    {   /* SYNC mode. */
        ...
        {
            eRetVal = Fls_Qspi_IPRead_SYNCMode(u32StartAddr, u32DataLength, p8DataReadPtr, p8DataCmpPtr);
        }
    ...
    {   /* IRQ mode. */
        ...
        eRetVal = Fls_Qspi_IPRead_IRQMode(u32StartAddr, u32DataLength, p8DataReadPtr, p8DataCmpPtr);
        #endif
    }    
...
/** 
* @brief        Qspi IP Synchronous mode read.
*
* @details      Performs a read job in IP Synchronous mode, using the RXBuffer and manually triggered commands.
*
* @param[in]    u32StartAddr    - start address of the read job, as is needed by the QSPI IP controller.
*                                 the address represents the external sector address(as needed by 
                                  the external memory), offset-ed over the QSPI hardware channel offset
...
#if(FLS_USE_INTERRUPTS == STD_ON)
/**
* @brief        Qspi IP IRQ mode read.
*
* @details      Performs a read job in IP IRQ mode, using the RXBuffer and manually triggered commands.
*
* @param[in]    u32StartAddr    - start address of the read job, as is needed by the QSPI IP controller.
*                                 the address represents the external sector address(as needed by 
                                  the external memory), offset-ed over the QSPI hardware channel offset
...
/**
* @brief          Write asynchronous operations(ASYNC and IRQ modes) for one or more flash pages into given flash sector.
*
...
*
*/
FUNC( Fls_LLDReturnType, FLS_CODE ) Fls_Qspi_SectorWriteAsync
(
...
/**
* @brief          Write synchronous operations for one or more flash pages into given flash sector.
*
* @param[in]      u32StartAddr      Memory mapped(offset-ed) QSPI address
* @param[in]      u32DataLength     Data length in bytes
* @param[in]      pDataPtr          Data to be written
...
*
*/
FUNC( Fls_LLDReturnType, FLS_CODE ) Fls_Qspi_SectorWriteSync
(
    CONST(Fls_AddressType, AUTOMATIC) u32StartAddr,
    CONST(Fls_LengthType, AUTOMATIC) u32DataLength,
    P2CONST(uint8, AUTOMATIC, FLS_APPL_CONST) p8DataPtr
