...
* 
*/
FUNC(uint32, RTE_CODE) Icu_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD FUNC(uint32, RTE_CODE) Icu_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#else
...
/*================================================================================================*/
/** 
* @brief   This function is called to allow ICU to enter the specific critical region. 
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_00(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_00 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_00 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_01(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_01 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_01 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_02(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_02 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_02 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_03(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_03 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_03 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_04(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_04 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_04 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_05(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_05 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_05 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_06(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_06 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_06 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_07(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_07 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_07 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_08(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_08 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_08 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_09(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_09 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_09 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_10(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_10 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_10 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_11(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_11 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_11 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_12(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_12 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_12 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_13(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_13 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_13 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_14(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_14 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_14 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_15(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_15 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_15 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_16(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_16 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_16 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_17(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_17 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_17 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_18(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_18 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_18 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_19(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_19 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_19 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_20(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_20 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_20 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_21(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_21 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_21 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_22(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_22 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_22 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_23(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_23 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_23 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_24(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_24 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_24 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_25(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_25 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_25 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_26(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_26 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_26 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_27(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_27 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_27 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_28(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_28 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_28 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_29(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_29 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_29 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_30(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_30 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_30 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_31(void)
{
    if(0UL == reentry_guard_31)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_31 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_31 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_32(void)
{
    if(0UL == reentry_guard_32)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_32 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_32 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_33(void)
{
    if(0UL == reentry_guard_33)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_33 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_33 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_34(void)
{
    if(0UL == reentry_guard_34)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_34 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_34 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_35(void)
{
    if(0UL == reentry_guard_35)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_35 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_35 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_36(void)
{
    if(0UL == reentry_guard_36)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_36 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_36 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_37(void)
{
    if(0UL == reentry_guard_37)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_37 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_37 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_38(void)
{
    if(0UL == reentry_guard_38)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_38 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_38 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_39(void)
{
    if(0UL == reentry_guard_39)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_39 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_39 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_40(void)
{
    if(0UL == reentry_guard_40)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_40 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_40 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_41(void)
{
    if(0UL == reentry_guard_41)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_41 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_41 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_42(void)
{
    if(0UL == reentry_guard_42)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_42 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_42 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_43(void)
{
    if(0UL == reentry_guard_43)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_43 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_43 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_44(void)
{
    if(0UL == reentry_guard_44)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_44 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_44 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_45(void)
{
    if(0UL == reentry_guard_45)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_45 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_45 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_46(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_46 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_46 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_47(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_47 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_47 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_48(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_48 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_48 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_49(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_49 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_49 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_50(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_50 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_50 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_51(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_51 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_51 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_52(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_52 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_52 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_53(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_53 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_53 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_54(void)
{
    if(0UL == reentry_guard_54)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_54 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_54 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_55(void)
{
    if(0UL == reentry_guard_55)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_55 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_55 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_56(void)
{
    if(0UL == reentry_guard_56)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_56 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_56 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_57(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_57 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_57 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_58(void)
{
    ...
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_58 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_58 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_59(void)
{
    if(0UL == reentry_guard_59)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_59 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_59 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_60(void)
{
    if(0UL == reentry_guard_60)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_60 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_60 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_61(void)
{
    if(0UL == reentry_guard_61)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_61 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_61 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_62(void)
{
    if(0UL == reentry_guard_62)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_62 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_62 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_63(void)
{
    if(0UL == reentry_guard_63)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_63 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_63 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_64(void)
{
    if(0UL == reentry_guard_64)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_64 = Mcal_Trusted_Call_Return(Icu_schm_read_msr);
#else
       msr_64 = Icu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
/*================================================================================================*/
/** 
* @brief   This function is called to allow ICU to exit the specific critical region. 
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_31(void)
{
    reentry_guard_31--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_32(void)
{
    reentry_guard_32--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_33(void)
{
    reentry_guard_33--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_34(void)
{
    reentry_guard_34--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_35(void)
{
    reentry_guard_35--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_36(void)
{
    reentry_guard_36--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_37(void)
{
    reentry_guard_37--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_38(void)
{
    reentry_guard_38--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_39(void)
{
    reentry_guard_39--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_40(void)
{
    reentry_guard_40--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_41(void)
{
    reentry_guard_41--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_42(void)
{
    reentry_guard_42--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_43(void)
{
    reentry_guard_43--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_44(void)
{
    reentry_guard_44--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_45(void)
{
    reentry_guard_45--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_54(void)
{
    reentry_guard_54--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_55(void)
{
    reentry_guard_55--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_56(void)
{
    reentry_guard_56--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_59(void)
{
    reentry_guard_59--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_60(void)
{
    reentry_guard_60--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_61(void)
{
    reentry_guard_61--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_62(void)
{
    reentry_guard_62--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_63(void)
{
    reentry_guard_63--;
...
FUNC (void, RTE_CODE) SchM_Exit_Icu_ICU_EXCLUSIVE_AREA_64(void)
{
    reentry_guard_64--;
