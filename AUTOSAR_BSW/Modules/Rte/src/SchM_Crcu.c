...
* 
*/
FUNC(uint32, RTE_CODE) Crcu_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD FUNC(uint32, RTE_CODE) Crcu_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#else
...
#ifdef MCAL_PLATFORM_S12
    #define Crcu_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define Crcu_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
/*================================================================================================*/
/** 
* @brief   This function is called to allow CRCU to enter the specific critical region. 
...
* 
*/
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_00(void)
{
    if(0UL == reentry_guard_00)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_00 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_00 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_01(void)
{
    if(0UL == reentry_guard_01)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_01 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_01 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_02(void)
{
    if(0UL == reentry_guard_02)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_02 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_02 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_03(void)
{
    if(0UL == reentry_guard_03)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_03 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_03 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_04(void)
{
    if(0UL == reentry_guard_04)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_04 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_04 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_05(void)
{
    if(0UL == reentry_guard_05)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_05 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_05 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_06(void)
{
    if(0UL == reentry_guard_06)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_06 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_06 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_07(void)
{
    if(0UL == reentry_guard_07)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_07 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_07 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_08(void)
{
    if(0UL == reentry_guard_08)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_08 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_08 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_09(void)
{
    if(0UL == reentry_guard_09)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_09 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_09 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_10(void)
{
    if(0UL == reentry_guard_10)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_10 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_10 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_11(void)
{
    if(0UL == reentry_guard_11)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_11 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_11 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_12(void)
{
    if(0UL == reentry_guard_12)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_12 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_12 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_13(void)
{
    if(0UL == reentry_guard_13)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_13 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_13 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_14(void)
{
    if(0UL == reentry_guard_14)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_14 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_14 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_15(void)
{
    if(0UL == reentry_guard_15)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_15 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_15 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_16(void)
{
    if(0UL == reentry_guard_16)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_16 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_16 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_17(void)
{
    if(0UL == reentry_guard_17)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_17 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_17 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_18(void)
{
    if(0UL == reentry_guard_18)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_18 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_18 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_19(void)
{
    if(0UL == reentry_guard_19)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_19 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_19 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_20(void)
{
    if(0UL == reentry_guard_20)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_20 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_20 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_21(void)
{
    if(0UL == reentry_guard_21)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_21 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_21 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_22(void)
{
    if(0UL == reentry_guard_22)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_22 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_22 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_23(void)
{
    if(0UL == reentry_guard_23)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_23 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_23 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_24(void)
{
    if(0UL == reentry_guard_24)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_24 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_24 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_25(void)
{
    if(0UL == reentry_guard_25)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_25 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_25 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_26(void)
{
    if(0UL == reentry_guard_26)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_26 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_26 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_27(void)
{
    if(0UL == reentry_guard_27)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_27 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_27 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_28(void)
{
    if(0UL == reentry_guard_28)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_28 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_28 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_29(void)
{
    if(0UL == reentry_guard_29)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_29 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_29 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
FUNC (void, RTE_CODE) SchM_Enter_Crcu_CRCU_EXCLUSIVE_AREA_30(void)
{
    if(0UL == reentry_guard_30)
    {
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
       msr_30 = Mcal_Trusted_Call_Return(Crcu_schm_read_msr);
#else
       msr_30 = Crcu_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
...
/*================================================================================================*/
/** 
* @brief   This function is called to allow CRCU to exit the specific critical region. 
...
* 
*/
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_00(void)
{
    reentry_guard_00--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_01(void)
{
    reentry_guard_01--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_02(void)
{
    reentry_guard_02--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_03(void)
{
    reentry_guard_03--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_04(void)
{
    reentry_guard_04--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_05(void)
{
    reentry_guard_05--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_06(void)
{
    reentry_guard_06--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_07(void)
{
    reentry_guard_07--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_08(void)
{
    reentry_guard_08--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_09(void)
{
    reentry_guard_09--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_10(void)
{
    reentry_guard_10--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_11(void)
{
    reentry_guard_11--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_12(void)
{
    reentry_guard_12--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_13(void)
{
    reentry_guard_13--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_14(void)
{
    reentry_guard_14--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_15(void)
{
    reentry_guard_15--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_16(void)
{
    reentry_guard_16--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_17(void)
{
    reentry_guard_17--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_18(void)
{
    reentry_guard_18--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_19(void)
{
    reentry_guard_19--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_20(void)
{
    reentry_guard_20--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_21(void)
{
    reentry_guard_21--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_22(void)
{
    reentry_guard_22--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_23(void)
{
    reentry_guard_23--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_24(void)
{
    reentry_guard_24--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_25(void)
{
    reentry_guard_25--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_26(void)
{
    reentry_guard_26--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_27(void)
{
    reentry_guard_27--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_28(void)
{
    reentry_guard_28--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_29(void)
{
    reentry_guard_29--;
...
FUNC (void, RTE_CODE) SchM_Exit_Crcu_CRCU_EXCLUSIVE_AREA_30(void)
{
    reentry_guard_30--;
...
@remarks Implements 
*/
FUNC(void, RTE_CODE) SchM_Check_crcu(void)
{
