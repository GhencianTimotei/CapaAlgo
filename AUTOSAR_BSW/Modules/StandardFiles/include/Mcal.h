...
*   SW Version           : 1.0.1
*   Build Version        : S32K14x_MCAL_1_0_1_RTM_HF1_ASR_REL_4_3_REV_0001_20191021
*
 ...
 * @violates @ref Mcal_h_REF_3 This is required as per autosar Requirement, 
 */
#define MCAL_AR_RELEASE_MINOR_VERSION     3
/*
 * @violates @ref Mcal_h_REF_3 This is required as per autosar Requirement, 
 */
#define MCAL_AR_RELEASE_REVISION_VERSION  1
...
/**************************************** Wind River Diab *****************************************/
    ...
    */
    /*
    * @violates @ref Mcal_h_REF_1 A function should be used in 
    * preference to function-like macro */
    #define EXECUTE_WAIT()  \
                do  \
                {   \
                    ResumeAllInterrupts();              \
                    ASM_KEYWORD("  .word 0x7C00007C");  \
                    SuspendAllInterrupts();             \
                } while (0)
    /**
    * @brief Compiler abstraction for the data alignment
