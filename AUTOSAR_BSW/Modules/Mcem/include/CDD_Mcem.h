...
#define CDD_MCEM_VENDOR_ID                    43
#define CDD_MCEM_MODULE_ID                    0U
/* @violates @ref CDD_Mcem_h_REF_2 Exceeds 31 characters */
#define CDD_MCEM_AR_RELEASE_MAJOR_VERSION     4
/* @violates @ref CDD_Mcem_h_REF_2 Exceeds 31 characters */
#define CDD_MCEM_AR_RELEASE_MINOR_VERSION     3
/* @violates @ref CDD_Mcem_h_REF_2 Exceeds 31 characters */
#define CDD_MCEM_AR_RELEASE_REVISION_VERSION  1
#define CDD_MCEM_SW_MAJOR_VERSION             1
#define CDD_MCEM_SW_MINOR_VERSION             0
#define CDD_MCEM_SW_PATCH_VERSION             1
...
#if (CDD_MCEM_VENDOR_ID != CDD_MCEM_VENDOR_ID_CFG)
...
#if ((CDD_MCEM_AR_RELEASE_MAJOR_VERSION    != CDD_MCEM_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (CDD_MCEM_AR_RELEASE_MINOR_VERSION    != CDD_MCEM_AR_RELEASE_MINOR_VERSION_CFG) || \
     (CDD_MCEM_AR_RELEASE_REVISION_VERSION != CDD_MCEM_AR_RELEASE_REVISION_VERSION_CFG))
...
#if ((CDD_MCEM_SW_MAJOR_VERSION != CDD_MCEM_SW_MAJOR_VERSION_CFG) || \
     (CDD_MCEM_SW_MINOR_VERSION != CDD_MCEM_SW_MINOR_VERSION_CFG) || \
     (CDD_MCEM_SW_PATCH_VERSION != CDD_MCEM_SW_PATCH_VERSION_CFG))
