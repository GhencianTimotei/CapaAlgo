...
/* @violates @ref CDD_Mcem_c_REF_3 31 character significance */
#define CDD_MCEM_AR_RELEASE_MINOR_VERSION_C       3
/* @violates @ref CDD_Mcem_c_REF_3 31 character significance */
#define CDD_MCEM_AR_RELEASE_REVISION_VERSION_C    1
...
#if (CDD_MCEM_VENDOR_ID_C != CDD_MCEM_VENDOR_ID)
...
#if ((CDD_MCEM_AR_RELEASE_MAJOR_VERSION_C    != CDD_MCEM_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_MCEM_AR_RELEASE_MINOR_VERSION_C    != CDD_MCEM_AR_RELEASE_MINOR_VERSION) || \
     (CDD_MCEM_AR_RELEASE_REVISION_VERSION_C != CDD_MCEM_AR_RELEASE_REVISION_VERSION))
...
#if ((CDD_MCEM_SW_MAJOR_VERSION_C != CDD_MCEM_SW_MAJOR_VERSION) || \
     (CDD_MCEM_SW_MINOR_VERSION_C != CDD_MCEM_SW_MINOR_VERSION) || \
     (CDD_MCEM_SW_PATCH_VERSION_C != CDD_MCEM_SW_PATCH_VERSION))
...
#endif
    {
        (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, MCEM_INIT_ID, MCEM_E_PARAM_CONFIG);
    }
    else
    {
...
LOCAL_INLINE FUNC(Std_ReturnType,MCEM_CODE) Mcem_ValidateErrorPtr(P2CONST(Mcem_FaultContainerType, AUTOMATIC, MCEM_APPL_VAR) pFaultsContainer)
{
    ...
    {
        (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, MCEM_GET_ERRORS_ID, MCEM_E_PARAM_FAULT);
    }
    else
    {
        nReturnValue = (Std_ReturnType)E_OK;
...
LOCAL_INLINE FUNC(Std_ReturnType,MCEM_CODE) Mcem_ValidateFaultId(VAR(Mcem_FaultType, AUTOMATIC) nFaultId, VAR(uint8, AUTOMATIC) u8FuncId)
{
    ...
    { 
        (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, u8FuncId, MCEM_E_PARAM_FAULT);
    }
    return nReturnValue;
}
...
LOCAL_INLINE FUNC(Std_ReturnType,MCEM_CODE) Mcem_CheckState(VAR(uint8, AUTOMATIC) u8FuncId)
{
    ...
    if ( MCEM_S_BUSY == Mcem_FunctionState[u8FuncId] )
    {
        ...
        (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, u8FuncId, MCEM_E_PREEMPTION);
    }
    else
    {
        switch (u8FuncId)
        {
            case MCEM_INIT_ID:
            {
                ...
                {
                    nReturnValue = (Std_ReturnType)E_NOT_OK;
                    (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, u8FuncId, MCEM_E_FORBIDDEN_INVOCATION);
                }
                break;
            }
            case MCEM_INJECT_FAULT_ID: 
            {
                ...
                {
                    nReturnValue = (Std_ReturnType)E_NOT_OK;
                    (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, u8FuncId, MCEM_E_UNINIT);
                }
                break;
            }
...
)
{
...
#endif
    {
        ...
        if ( (Std_ReturnType)E_OK == Mcem_CheckState(MCEM_INIT_ID) )
        {
            ...
            MCAL_FAULT_INJECTION_POINT(FIP_T_MCEM_INIT_STATE);
            if ( (Std_ReturnType)E_OK != nReturnValue )
            {
...
)
{
    ...
    {
        (void)Det_ReportError(CDD_MCEM_MODULE_ID, MCEM_INSTANCE_ID, MCEM_GETVERSIONINFO_ID, MCEM_E_PARAM_VINFO);
    }
    else
#endif
    {
        (pVersionInfo)->vendorID         = (uint16)CDD_MCEM_VENDOR_ID;
        (pVersionInfo)->moduleID         = (uint8)CDD_MCEM_MODULE_ID;
        (pVersionInfo)->sw_major_version = (uint8)CDD_MCEM_SW_MAJOR_VERSION;
        (pVersionInfo)->sw_minor_version = (uint8)CDD_MCEM_SW_MINOR_VERSION;
        (pVersionInfo)->sw_patch_version = (uint8)CDD_MCEM_SW_PATCH_VERSION;
    }
}
