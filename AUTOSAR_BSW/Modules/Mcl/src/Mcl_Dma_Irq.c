...
#define MCL_DMA_IRQ_AR_RELEASE_MINOR_VERSION_C        3
#define MCL_DMA_IRQ_AR_RELEASE_REVISION_VERSION_C     1
...
)
{
    ...
    if ((uint32)0U != u32ErrorStatus )
    {
        ...
        if((uint32)0U != (u32ErrorStatus & DMA_ES_DESCRIPTOR_U32)) 
        {
            /* Descriptor error detected */
            Mcl_IPW_ErrorNotification(DmaHwInstance,MCL_DMA_DESCRIPTOR_ERROR);
        }
        if((uint32)0U != (u32ErrorStatus & (DMA_ES_GPE_U32 | DMA_ES_CPE_U32)))
        {
            /* Priority error detected */
            Mcl_IPW_ErrorNotification(DmaHwInstance,MCL_DMA_PRIORITY_ERROR);
        }
        if((uint32)0U == (u32ErrorStatus & (DMA_ES_GPE_U32 | DMA_ES_CPE_U32 | DMA_ES_DESCRIPTOR_U32 | DMA_ES_BUS_U32 | DMA_ES_UCE_U32)))
        { 
