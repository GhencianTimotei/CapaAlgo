...
/** @violates @ref LPIT_COMMON_C_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be 
*checked to ensure that 31 character significance and case sensitivity are supported for external identifiers. */
#define LPIT_COMMON_AR_RELEASE_MINOR_VERSION_C        3
/** @violates @ref LPIT_COMMON_C_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be 
*checked to ensure that 31 character significance and case sensitivity are supported for external identifiers. */
#define LPIT_COMMON_AR_RELEASE_REVISION_VERSION_C     1
/** @violates @ref LPIT_COMMON_C_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be 
*checked to ensure that 31 character significance and case sensitivity are supported for external identifiers. */
...
ISR(LPIT_0_CH_3_ISR);
#endif
#if ( (defined GPT_LPIT_0_ISR_USED) || (defined ICU_LPIT_0_ISR_USED) || ((defined GPT_LPIT_MODULE_SINGLE_INTERRUPT) && (GPT_LPIT_MODULE_SINGLE_INTERRUPT == STD_ON)) || ((defined ICU_LPIT_MODULE_SINGLE_INTERRUPT) && (ICU_LPIT_MODULE_SINGLE_INTERRUPT == STD_ON)))
ISR(LPIT_0_ISR);
#endif
