...
#define MCL_DMA_AR_RELEASE_MINOR_VERSION_C     3
#define MCL_DMA_AR_RELEASE_REVISION_VERSION_C  1
...
)
{
        ...
        )
    {
        ...
        {
                            (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Inconsistency.id, DEM_EVENT_STATUS_FAILED);
                    }
    }
    else if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Inconsistency.state)
    {
                            (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Inconsistency.id, DEM_EVENT_STATUS_PASSED);
                }
    else
    {
    /*do nothing*/
    ...
    if((uint32)0U != (u32GlobalErrorStatus & DMA_ES_UCE_U32))
    {
        ...
        {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Ecc.id, DEM_EVENT_STATUS_FAILED);
                    }
    }
    else if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Ecc.state)
    {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Ecc.id, DEM_EVENT_STATUS_PASSED);
                }
    else
    {
    /*do nothing*/
    ...
    if ((uint32)0U != (u32GlobalErrorStatus & DMA_ES_BUS_U32))
    {
        ...
        {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Bus.id, DEM_EVENT_STATUS_FAILED);
                    }
    }
    else if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Bus.state)
    {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Bus.id, DEM_EVENT_STATUS_PASSED);
                }
    else
    {
    /*do nothing*/
    ...
    if ((uint32)0U != (u32GlobalErrorStatus & DMA_ES_DESCRIPTOR_U32)) 
    {
        ...
        {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Descriptor.id, DEM_EVENT_STATUS_FAILED);
                    }
    }
    else if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Descriptor.state)
    {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Descriptor.id, DEM_EVENT_STATUS_PASSED);
                }
    else
    {
    /*do nothing*/
    ...
    if ((uint32)0U != (u32GlobalErrorStatus & (DMA_ES_GPE_U32 | DMA_ES_CPE_U32)))
    {
        ...
        {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Priority.id, DEM_EVENT_STATUS_FAILED);
                    }
    }            
    else if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Priority.state)
    {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Priority.id, DEM_EVENT_STATUS_PASSED);
                }
    else
    {
    /*do nothing*/
    ...
    if (errorStatus == MCL_DMA_UNRECOGNIZED_ERROR)
    {
        ...
        {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Unrecognized.id, DEM_EVENT_STATUS_FAILED);
                    }
    }
    else if (errorStatus == MCL_DMA_NO_ERROR)
    {
        if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Unrecognized.state)
        {
                              (void) Dem_SetEventStatus((Dem_EventIdType)Mcl_pDemCfgPtr->Mcl_E_Dma_Unrecognized.id, DEM_EVENT_STATUS_PASSED);
                    }
    }
    else
    {
