...
#define MCL_AR_RELEASE_MINOR_VERSION        3
#define MCL_AR_RELEASE_REVISION_VERSION     1
...
/**
* @brief API service ID for Mcl_Flexio_ClearShiftStat function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_CLEARSHIFTSTAT_ID_U8            ((uint8)0x75U)

/**
* @brief API service ID for Mcl_Flexio_ReadShiftStat function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READSHIFTSTAT_ID_U8             ((uint8)0x76U)

/**
* @brief API service ID for Mcl_Flexio_ClearShiftErr function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_CLEARSHIFTERR_ID_U8             ((uint8)0x77U)

/**
* @brief API service ID for Mcl_Flexio_ReadShiftErr function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READSHIFTERR_ID_U8              ((uint8)0x78U)

/**
* @brief API service ID for Mcl_Flexio_ClearTimStat function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_CLEARTIMSTAT_ID_U8              ((uint8)0x79U)
/**
* @brief API service ID for Mcl_Flexio_ReadTimStat function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READTIMSTAT_ID_U8               ((uint8)0x7AU)

/**
* @brief API service ID for Mcl_Flexio_EnableShiftSien function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_ENABLESHIFTSIEN_ID_U8           ((uint8)0x7BU)

/**
* @brief API service ID for Mcl_Flexio_DisableShiftSien function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_DISABLESHIFTSIEN_ID_U8          ((uint8)0x7CU)

/**
* @brief API service ID for Mcl_Flexio_ReadShiftSien function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READSHIFTSIEN_ID_U8             ((uint8)0x7DU)

/**
* @brief API service ID for Mcl_Flexio_WriteShiftEien function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_ENABLESHIFTEIEN_ID_U8           ((uint8)0x7EU)

/**
* @brief API service ID for Mcl_Flexio_DisableShiftEien function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_DISABLESHIFTEIEN_ID_U8          ((uint8)0x7FU)

/**
* @brief API service ID for Mcl_Flexio_ReadShiftEien function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READSHIFTEIEN_ID_U8             ((uint8)0x80U)

/**
* @brief API service ID for Mcl_Flexio_WriteTimIen function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_ENABLETIMIEN_ID_U8              ((uint8)0x81U)

/**
* @brief API service ID for Mcl_Flexio_DisableTimIen function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_DISABLETIMIEN_ID_U8             ((uint8)0x82U)

/**
* @brief API service ID for Mcl_Flexio_ReadTimIen function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READTIMIEN_ID_U8                ((uint8)0x83U)

/**
* @brief API service ID for Mcl_Flexio_WriteShiftSden function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_ENABLESHIFTSDEN_ID_U8           ((uint8)0x84U)

/**
* @brief API service ID for Mcl_Flexio_DisableShiftSden function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_DISABLESHIFTSDEN_ID_U8          ((uint8)0x85U)

/**
* @brief API service ID for Mcl_Flexio_ReadShiftSden function
* @details Parameters used when raising an error/exception
* */
#define MCL_FLEXIO_READSHIFTSDEN_ID_U8             ((uint8)0x86U)
...
/**
* @brief            API service ID of Mcl_SelectCommonTimebase function
* @details          Parameters used when raising an error/exception
*/
#define MCL_SELECTCOMMONTIMEBASE_ID          ((uint8)(0x60U))
...
#endif
#if (MCL_ENABLE_FLEXIO == STD_ON)
    P2CONST(Mcl_FlexioConfigType, MCL_VAR, MCL_APPL_CONST)               pMclFlexioConfig;
#endif
} Mcl_ConfigType;
...
#include "Mcl_MemMap.h"
#if (MCL_ENABLE_FLEXIO == STD_ON)
#define MCL_START_SEC_VAR_INIT_8
/** @violates @ref Mcl_h_1 Advisory Rule 19.1 only preprocessor statements and comments before "#include" */
/** @violates @ref Mcl_h_2 Required Rule 19.15 header file being included twice */
#include "Mcl_MemMap.h"

extern  VAR(uint8, AUTOMATIC) Mcl_FlexIO_u8ShifterMaskFlag;
extern  VAR(uint8, AUTOMATIC) Mcl_FlexIO_u8ErrMaskFlag;
extern  VAR(uint8, AUTOMATIC) Mcl_FlexIO_u8TimerMaskFlag;

#define MCL_STOP_SEC_VAR_INIT_8
/** @violates @ref Mcl_h_1 Advisory Rule 19.1 only preprocessor statements and comments before "#include" */
/** @violates @ref Mcl_h_2 Required Rule 19.15 header file being included twice */
#include "Mcl_MemMap.h"
#endif
...
#endif /* #if (STD_ON == MCL_SELECT_COMMON_TIMEBASE_API)  */
