...
#define MCL_IPW_AR_RELEASE_MINOR_VERSION        3
#define MCL_IPW_AR_RELEASE_REVISION_VERSION     1
...
#if (MCL_SELECT_COMMON_TIMEBASE_API == STD_ON)
    #if (MCL_IPW_VENDOR_ID != FTM_COMMON_VENDOR_ID)
        #error "Mcl_IPW.h and Ftm_Common.h have different vendor IDs"
    #endif
    #ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if source file and Ftm_Common header file are of the same Autosar version */
    #if ((MCL_IPW_AR_RELEASE_MAJOR_VERSION != FTM_COMMON_AR_RELEASE_MAJOR_VERSION) || \
         (MCL_IPW_AR_RELEASE_MINOR_VERSION != FTM_COMMON_AR_RELEASE_MINOR_VERSION) || \
         (MCL_IPW_AR_RELEASE_REVISION_VERSION != FTM_COMMON_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Mcl_IPW.h and Ftm_Common.h are different"
    #endif
    #endif
    /* Check if source file and Ftm_Common header file are of the same Software version */
    #if ((MCL_IPW_SW_MAJOR_VERSION != FTM_COMMON_SW_MAJOR_VERSION) || \
         (MCL_IPW_SW_MINOR_VERSION != FTM_COMMON_SW_MINOR_VERSION) || \
         (MCL_IPW_SW_PATCH_VERSION != FTM_COMMON_SW_PATCH_VERSION))
    #error "Software Version Numbers of Mcl_IPW.h and Ftm_Common.h are different"
    #endif
#endif
/*==================================================================================================
*                                            CONSTANTS
...
==================================================================================================*/
...
#if (MCL_ENABLE_FLEXIO == STD_ON)
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_Init(u32FlexIOConfig)                                        (Mcl_Flexio_Init(u32FlexIOConfig))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_DeInit()                                                     (Mcl_Flexio_DeInit())
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_Enable()                                                     (Mcl_Flexio_ModuleEnable())
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_Disable()                                                    (Mcl_Flexio_ModuleDisable())
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ClearShiftStat(u8ShifterMask)                                (Mcl_Flexio_ClrShiftStat((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadShiftStat(u8ShifterMask)                                 (Mcl_Flexio_RdShiftStat((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ClearShiftErr(u8ShifterMask)                                 (Mcl_Flexio_ClrShiftErr((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadShiftErr(u8ShifterMask)                                  (Mcl_Flexio_RdShiftErr((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ClearTimStat(u8TimerMask)                                    (Mcl_Flexio_ClrTimStat((u8TimerMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadTimStat(u8TimerMask)                                     (Mcl_Flexio_RdTimStat((u8TimerMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_WriteShiftSien(u8ShifterMask, u8ShifterEnableMask)           (Mcl_Flexio_WrShiftSien((u8ShifterMask),(u8ShifterEnableMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadShiftSien(u8ShifterMask)                                 (Mcl_Flexio_RdShiftSien((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_WriteShiftEien(u8ShifterMask, u8ShifterEnableMask)           (Mcl_Flexio_WrShiftEien((u8ShifterMask),(u8ShifterEnableMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadShiftEien(u8ShifterMask)                                 (Mcl_Flexio_RdShiftEien((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_WriteTimIen(u8TimerMask, u8TimerEnableMask)                  (Mcl_Flexio_WrTimIen((u8TimerMask),(u8TimerEnableMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadTimIen(u8TimerMask)                                      (Mcl_Flexio_RdTimIen((u8TimerMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_WriteShiftSden(u8ShifterMask, u8ShifterEnableMask)           (Mcl_Flexio_WrShiftSden((u8ShifterMask),(u8ShifterEnableMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_ReadShiftSden(u8ShifterMask)                                 (Mcl_Flexio_RdShiftSden((u8ShifterMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_EnableInterrupts(u8ShifterMask, u8ErrMask, u8TimerMask)      (Mcl_Flexio_SetInterrupts((u8ShifterMask),(u8ErrMask),(u8TimerMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_DisableInterrupts(u8ShifterMask, u8ErrMask, u8TimerMask)     (Mcl_Flexio_ClrInterrupts((u8ShifterMask),(u8ErrMask),(u8TimerMask)))
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_IPW_Flexio_SoftwareReset()                                              (Mcl_Flexio_SwReset())
    ...
    */
    /** @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define Mcl_Ipw_SelectCommonTimebase(ModuleId, u16ElementSyncList)   Mcl_Ftm_SelectCommonTimebase((ModuleId), (u16ElementSyncList))
