...
*
* @section I2C_LPI2C_c_REF_8
* Violates MISRA 2004 Required Rule 8.7, Objects shall be defined at block scope if they are only
* accessed from within a single function.
* These objects must have internal linkage and cannot be defined local to the function, because
* they must be contained within a specific memory section as per AUTOSAR requirements.
*
*/
...
* external identifiers.
*/
#define I2C_LPI2C_AR_RELEASE_MINOR_VERSION_C       3
/**
* @violates @ref I2C_LPI2C_c_REF_5 The compiler/linker shall be checked to
* ensure that 31 character significance and case sensitivity are supported for
* external identifiers.
*/
#define I2C_LPI2C_AR_RELEASE_REVISION_VERSION_C    1
...
/* Check if current file and DEM header file are of the same version */
    ...
    /* Check if the source file and Dem header file are of the same version */
      ...
      #error "AutoSar Version Numbers of I2c_LPI2C.c and Dem.h are different"
  #endif
#endif
...
/**
* @brief    Used to indicate the current state of the Slave.
*/
static P2FUNC(void, I2C_CODE, I2c_LPI2C_pfSlaveStateOperation[I2C_LPI2C_MAX_MODULES]) (CONST(uint8, AUTOMATIC) u8Channel, CONST(uint32, AUTOMATIC) u32SlaveIsrStatus);
...
/**
* @brief    Used to indicate the Slave shall send an ACK or a NACK after a byte reception.
*/
static VAR( boolean, I2C_VAR) I2c_LPI2C_bSendAck[I2C_LPI2C_MAX_MODULES];
#endif
/**
* @brief    Used to indicate if a Repeated Start (Sr) should be generated instead of a STOP.
*/
static VAR(boolean, I2C_VAR) I2c_LPI2C_abRepeatedStart[I2C_LPI2C_MAX_MODULES];
...
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveUninitialized(CONST(uint8, AUTOMATIC) u8Channel, CONST(uint32, AUTOMATIC) u32SlaveIsrStatus);
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveProcessAddress(CONST(uint8, AUTOMATIC) u8Channel, CONST(uint32, AUTOMATIC) u32SlaveIsrStatus);
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveIdle(CONST(uint8, AUTOMATIC) u8Channel, CONST(uint32, AUTOMATIC) u32SlaveIsrStatus);
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveError(CONST(uint8, AUTOMATIC) u8Channel, CONST(uint32, AUTOMATIC) u32SlaveIsrStatus);
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveProcessStop(CONST(uint8, AUTOMATIC) u8Channel, CONST(uint32, AUTOMATIC) u32SlaveIsrStatus);

static FUNC (void, I2C_CODE) I2c_LPI2C_SlaveReceive(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus);
static FUNC (void, I2C_CODE) I2c_LPI2C_SlaveTransmit(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus);
...
static FUNC (void, I2C_CODE) I2c_LPI2C_DmaSendProcessing(VAR(uint8, AUTOMATIC) u8HwChannel)
{
    ...
    if (0x0U == I2c_LPI2C_au8ErrorsFound[u8HwChannel])
    {
        ...
        else /* the data transfer is over */
        {
            ...
            {
                if ((boolean)FALSE == I2c_LPI2C_abRepeatedStart[u8HwChannel])
                {
                    /* Send a stop command */
...
static FUNC (void, I2C_CODE) I2c_LPI2C_SlaveErrorHandler(VAR(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32IsrStatus)
{
    ...
    if (0x0U != (u32IsrStatus & LPI2C_SSR_ERROR_FLAGS_MASK_U32))
    {
        ...
        I2c_LPI2C_pfSlaveStateOperation[u8Channel] = &I2c_LPI2C_SlaveError;
...
#ifdef I2C_ERROR_NOTIFICATION
            I2C_ERROR_NOTIFICATION((uint8)I2c_as8ChannelHardwareMap[u8Channel], I2C_E_SLAVE_FIFO_ERROR);
#endif
        }
        ...
        {
            I2C_ERROR_NOTIFICATION((uint8)I2c_as8ChannelHardwareMap[u8Channel], I2C_E_SLAVE_BIT_ERROR);
        }
#endif
    }
}
...
static FUNC (Std_ReturnType, I2C_CODE) I2c_LPI2C_MasterSendAddress(CONST(uint8, AUTOMATIC) u8Channel, P2CONST(I2c_RequestType, AUTOMATIC, I2C_APPL_CONST) pRequestPtr)
{
    ...
    if ((boolean)FALSE == I2c_LPI2C_abRepeatedStart[u8Channel])
    {
        /* Wait until the bus is idle or timeout expires, whichever comes first */
        do
        {
            /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
            /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
...
static FUNC (Std_ReturnType, I2C_CODE) I2c_LPI2C_MasterSyncSend(CONST(uint8, AUTOMATIC) u8Channel)
{
    ...
    if (I2c_LPI2C_au8CurrentIndex[u8Channel] == (I2c_LPI2C_au8NumberOfBytes[u8Channel] + 1U))
    {
        if ((boolean)FALSE == I2c_LPI2C_abRepeatedStart[u8Channel])
        {
            /* Send Stop command */
...
FUNC (void, I2C_CODE) I2c_LPI2C_InitChannel(CONST(uint8, AUTOMATIC) u8Channel, P2CONST(I2c_LPI2C_HwChannelConfigType, AUTOMATIC, I2C_APPL_CONST) pConfigPtr)
{
    ...
    {
        /* The repeated start flag is initially false and set by the application through a transfer request */
        I2c_LPI2C_abRepeatedStart[u8Channel] = (boolean)FALSE;
    ...
    if ( I2C_MASTER_MODE != (*I2c_pConfig->I2c_pHwConfig)[I2c_as8ChannelHardwareMap[u8Channel]].eMasterSlaveConfig )
    {
        ...
        I2c_LPI2C_pfSlaveStateOperation[u8Channel] = &I2c_LPI2C_SlaveIdle;
...
FUNC(void, I2C_CODE)  I2c_LPI2C_StartListening(VAR(uint8, AUTOMATIC) u8Channel)
{
    ...
    /* Set I2c_LPI2C_pfSlaveStateOperation to process Address */
    I2c_LPI2C_pfSlaveStateOperation[u8Channel] = &I2c_LPI2C_SlaveProcessAddress;
}
...
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveProcessAddress(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus)
{
    VAR(sint8, AUTOMATIC) s8LogicalChannel = I2c_as8ChannelHardwareMap[u8Channel];

    /* Check for Transmit ACK/NACK is required */
    if (0U != (u32SlaveIsrStatus & LPI2C_SSR_TAF_MASK_U32))
    {
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
        REG_WRITE32(LPI2C_STAR_ADDR32(u8Channel), LPI2C_TRANSMIT_ACK_U32); 
    }

    /* Check for ADDR0 matching address */
    if (0U != (u32SlaveIsrStatus & LPI2C_SSR_AM0F_MASK_U32))
    {
        /* Check for slave receive or send */
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
        if (LPI2C_MTDR_READ_BIT_MASK_U8 == (REG_READ32(LPI2C_SASR_ADDR32(u8Channel)) & LPI2C_MTDR_READ_BIT_MASK_U8))
        {
            ...
            /* Set I2c_LPI2C_pfSlaveStateOperation to process transmit */
            I2c_LPI2C_pfSlaveStateOperation[u8Channel] = &I2c_LPI2C_SlaveTransmit;
        ...
        else
        {
            ...
            /* Set I2c_LPI2C_pfSlaveStateOperation to process receive */
            I2c_LPI2C_pfSlaveStateOperation[u8Channel] = &I2c_LPI2C_SlaveReceive;
...
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveIdle(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus)
{
    /* Check for Transmit ACK/NACK is required */
    if (0U != (u32SlaveIsrStatus & LPI2C_SSR_TAF_MASK_U32))
    {
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
        REG_WRITE32(LPI2C_STAR_ADDR32(u8Channel), LPI2C_TRANSMIT_NACK_U32);
    }
    /* if address match then clear flag */
    if (0U != (u32SlaveIsrStatus & LPI2C_SSR_AM0F_MASK_U32))
    {
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
...
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveError(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus)
{
    /* Disable TDIE interrupt and reset Transmit FIFO */
    I2c_LPI2C_SlaveDisableTransmitDataInterrupt(u8Channel);
    ...
    if (
        (LPI2C_SMBUS_ALERT_RESPONSE_DETECTED_U32 == (u32SlaveIsrStatus & LPI2C_SSR_SARF_MASK_U32)) ||
        (LPI2C_GENERAL_CALL_ADDRESS_DETECTED_U32 == (u32SlaveIsrStatus & LPI2C_SSR_GCF_MASK_U32)) ||
        (LPI2C_ADDRESS1_MATCH_U32 == (u32SlaveIsrStatus & LPI2C_SSR_AM1F_MASK_U32)) ||
        (LPI2C_ADDRESS0_MATCH_U32 == (u32SlaveIsrStatus & LPI2C_SSR_AM0F_MASK_U32)) ||
        (LPI2C_SLAVE_ADDRESS_VALID_U32 == (u32SlaveIsrStatus & LPI2C_SSR_AVF_MASK_U32))
       )
    {
    ...
    if (LPI2C_TRANSMIT_ACK_REQUIRED_U32 == (u32SlaveIsrStatus & LPI2C_SSR_TAF_MASK_U32))
    {
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
        REG_WRITE32(LPI2C_STAR_ADDR32(u8Channel), LPI2C_TRANSMIT_NACK_U32);
    ...
    if (LPI2C_SLAVE_RECEIVE_DATA_IS_READY_U32 == (u32SlaveIsrStatus & LPI2C_SSR_RDF_MASK_U32))
    {
        /* Reset Receive FIFO */
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
...
static FUNC(void, I2C_CODE) I2c_LPI2C_SlaveProcessStop(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus)
{
    VAR(sint8, AUTOMATIC) s8LogicalChannel = I2c_as8ChannelHardwareMap[u8Channel];
    ...
    if (0U != (u32SlaveIsrStatus & (LPI2C_SSR_SDF_MASK_U32 | LPI2C_SSR_RSF_MASK_U32)))
    {
        /* Disable TDIE interrupt and reset Transmit FIFO */
        I2c_LPI2C_SlaveDisableTransmitDataInterrupt(u8Channel);
        ...
        /* Used to indicate the Slave is idle */
        I2c_LPI2C_pfSlaveStateOperation[u8Channel] = &I2c_LPI2C_SlaveIdle;
...
static FUNC (void, I2C_CODE) I2c_LPI2C_SlaveTransmit(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus)
{
    /* check for transmit interrupt enable and Transmit data is requested */
    /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
    /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
    if ((0U != (REG_READ32(LPI2C_SIER_ADDR32(u8Channel)) & LPI2C_SIER_TDIE_MASK_U32)) && (0U != (u32SlaveIsrStatus & LPI2C_SSR_TDF_MASK_U32)))
    {
    ...
    I2c_LPI2C_SlaveProcessStop(u8Channel, u32SlaveIsrStatus);
}
...
static FUNC (void, I2C_CODE) I2c_LPI2C_SlaveReceive(CONST(uint8, AUTOMATIC) u8Channel, VAR(uint32, AUTOMATIC) u32SlaveIsrStatus)
{
    ...
    /* Check for Receive data is ready */
    if (0U != (u32SlaveIsrStatus & LPI2C_SSR_RDF_MASK_U32))
    {
        /* Read data received */
        /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
        /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
        ...
        /* If there are more bytes to be received */
        if (I2c_LPI2C_au8SlaveCurrentIndex[u8Channel] < I2c_LPI2C_au8SlaveNumberOfBytes[u8Channel])
        {    
            /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
            /** @violates @ref I2C_LPI2C_c_REF_6 MISRA 2004 Required Rule 17.4, Array indexing shall be the only allowed form of pointer */
...
#ifdef I2C_SLAVE_BYTE_RECEIVE_NOTIFICATION
            I2c_LPI2C_bSendAck[u8Channel] = (boolean) I2C_SLAVE_BYTE_RECEIVE_NOTIFICATION((uint8)I2c_as8ChannelHardwareMap[u8Channel], I2c_LPI2C_au8SlaveCurrentIndex[u8Channel]);
#endif
    ...
    {
#ifdef I2C_SLAVE_BYTE_RECEIVE_NOTIFICATION
        if ( (boolean)TRUE == I2c_LPI2C_bSendAck[u8Channel] )
        {
#endif
            /** @violates @ref I2C_LPI2C_c_REF_3 cast from unsigned int to pointer */
            /** @violates @ref I2C_LPI2C_c_REF_7 The cast is used to access memory mapped registers.*/
...
FUNC (void, I2C_CODE) I2c_LPI2C_SlaveInterruptHandler(CONST(uint8, AUTOMATIC) u8Channel)
{
    ...
    VAR( uint32, AUTOMATIC) u32SlaveIsrStatus;
    ...
    /* Check slave error interrupt */
    I2c_LPI2C_SlaveErrorHandler(u8Channel, u32SlaveIsrStatus);

    if (NULL_PTR != I2c_LPI2C_pfSlaveStateOperation[u8Channel])
    {
        (I2c_LPI2C_pfSlaveStateOperation[u8Channel])(u8Channel, u32SlaveIsrStatus);
    }
    else
    {
        I2c_LPI2C_SlaveUninitialized(u8Channel, u32SlaveIsrStatus);
    }
}
