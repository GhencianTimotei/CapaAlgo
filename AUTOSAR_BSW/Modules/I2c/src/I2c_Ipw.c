...
* external identifiers.
*/
#define I2C_AR_RELEASE_MINOR_VERSION_IPW_C     3
/*
* @violates @ref I2c_Ipw_c_REF_3 The compiler/linker shall be checked to
* ensure that 31 character significance and case sensitivity are supported for
* external identifiers.
*/
#define I2C_AR_RELEASE_REVISION_VERSION_IPW_C  1
...
#if (STD_ON == I2C_FLEXIO_USED)
    if (I2C_LPI2C_CHANNEL == eChannelType)
    {
...
#else
    (void)pRequest; /* avoid compiler warning */
    (void)eChannelType; /* avoid compiler warning */
    u8TmpReturn = (Std_ReturnType)E_OK;
#endif
    return u8TmpReturn;
}
...
{
#if (STD_ON == I2C_FLEXIO_USED)
    if (I2C_LPI2C_CHANNEL == (pConfigPtr->I2c_Ipw_eChannelType))
    {
#endif
