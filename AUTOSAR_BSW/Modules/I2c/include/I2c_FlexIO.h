...
#define I2C_FLEXIO_MODULE_ID                    255
/**
...
* external identifiers.
*/
#define I2C_FLEXIO_AR_RELEASE_MINOR_VERSION     3
/**
* @violates @ref I2c_FlexIO_h_REF_2 The compiler/linker shall be checked to
* ensure that 31 character significance and case sensitivity are supported for
* external identifiers.
*/
#define I2C_FLEXIO_AR_RELEASE_REVISION_VERSION  1
...
#endif
/* Check if current file and I2c_Types header file are of the same module */
#if (I2C_FLEXIO_MODULE_ID != I2C_TYPES_MODULE_ID)
    #error "I2c_FlexIO.h and I2c_Types.h have different module ids"
#endif
