...
/* @violates @ref Port_Port_Ci_C_REF_4 Violates MISRA 2004 Required Rule 1.4 */
#define PORT_PORT_CI_AR_RELEASE_MINOR_VERSION_C      3
/* @violates @ref Port_Port_Ci_C_REF_4 Violates MISRA 2004 Required Rule 1.4 */
#define PORT_PORT_CI_AR_RELEASE_REVISION_VERSION_C   1
...
)
{
    ...
    for (u16PinIndex = (uint16)0U; u16PinIndex < u16NumUnusedPins; u16PinIndex++)
    {
        ...
        Pin = pConfigPtr->pau16UnusedPads[u16PinIndex];
        ...
        * @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. 
        */
        REG_WRITE32(PORT_PORT_CI_PCR_ADDR32(Pin), u32LocalPCR);
    }
}
...
)
{
    ...
    for (u16PinIndex = (uint16)0U; u16PinIndex < (uint16)u8NumDigFilterPorts; u16PinIndex++)
    {
        ...
        * @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 
        */
        REG_WRITE32(PORT_PORT_CI_DFCR_ADDR32(u8Port), (uint32)(pConfigPtr->pDigitalFilterConfig[u16PinIndex].u8Clock));
        ...
        * @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 
        */
        REG_WRITE32(PORT_PORT_CI_DFWR_ADDR32(u8Port), (uint32)(pConfigPtr->pDigitalFilterConfig[u16PinIndex].u8Width));
        ...
        * @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 
        */
        REG_WRITE32(PORT_PORT_CI_DFER_ADDR32(u8Port), (uint32)(pConfigPtr->pDigitalFilterConfig[u16PinIndex].u32PinMask));
    }
...
)
{
    ...
    VAR(uint8,          AUTOMATIC) u8PinDescBitOffset       = (uint8)(Pin & PORT_CI_BIT_OFFSET_MASK_U8);
...
)
{
    ...
    VAR(uint8,          AUTOMATIC) u8PinDescBitOffset1       = (uint8)(Pin1 & PORT_CI_BIT_OFFSET_MASK_U8);
    VAR(uint16,         AUTOMATIC) u16PinChangeDirFlagWord1  = Port_Port_Ci_au16GpioDirChangeability[(uint8)(Pin1>>4)];

    VAR(uint8,          AUTOMATIC) u8PinDescBitOffset2       = (uint8)(Pin2 & PORT_CI_BIT_OFFSET_MASK_U8);
        ...
        if(GPIO_PORT_U32(Pin1) == GPIO_PORT_U32(Pin2))
        {
            ...
            else if ((PORT_PIN_IN == eDirection)  || (PORT_PIN_HIGH_Z == eDirection))
            {
                ...
                if(PORT_PIN_HIGH_Z == eDirection)
                {
                    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                    REG_BIT_SET32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin1)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin1)) | (uint32)(1UL << GPIO_CHANNEL_U32(Pin2)));
                }
            }
            else
            {
        ...
        else
        {
            ...
            else if ((PORT_PIN_IN == eDirection) || (PORT_PIN_HIGH_Z == eDirection))
            {
                ...
                if(PORT_PIN_HIGH_Z == eDirection)
                {
                    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                    REG_BIT_SET32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin1)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin1)));
                    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                    REG_BIT_SET32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin2)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin2)));
                }
            }
            else
            {
...
)
{
    ...
    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer */
    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
    u32LocalPCR  = REG_READ32(PORT_PORT_CI_PCR_ADDR32(PinCfgRegIndex));
    u32LocalPCR &= ~(PORT_CI_PCR_ALT_MODE_U32);

    u32LocalPCR |= ((uint32)PinCfgRegValue << PORT_CI_PCR_ALT_MODE_OFFSET_U32);
    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer */
    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
    REG_WRITE32(PORT_PORT_CI_PCR_ADDR32(PinCfgRegIndex), u32LocalPCR);
    ...
    for (u16PinIndex = (uint16)0U; u16PinIndex < u16NumPins; u16PinIndex++)
    {
        ...
        if ((boolean)FALSE == pConfigPtr->pUsedPadConfig[u16PinIndex].bDC)
        {
            ...
            if ((boolean)TRUE == pConfigPtr->pUsedPadConfig[u16PinIndex].bGPIO)
            {
                ...
                /* Configures Port Pin as Input or High-Z*/
                /* @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 */
                else if ((PORT_PIN_IN == pConfigPtr->pUsedPadConfig[u16PinIndex].ePDDir) || (PORT_PIN_HIGH_Z == pConfigPtr->pUsedPadConfig[u16PinIndex].ePDDir))
                {
                    /* Configure the pin direction as input in the PDDR register of GPIO IP */
                    /**
                    * @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer.
                    ...
                    */
                    ...
                    /* Check if the pin is HIGH-Z. In this case the driver needs to disable port input in PIDR register of GPIO IP*/
                    /* @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 */
                    if(PORT_PIN_HIGH_Z == pConfigPtr->pUsedPadConfig[u16PinIndex].ePDDir)
                    {
                        /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                        /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                        REG_BIT_SET32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(PinPad)), (uint32)(1UL << GPIO_CHANNEL_U32(PinPad)));
                    }
