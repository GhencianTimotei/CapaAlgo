...
/**
* @violates @ref PORT_IPW_H_REF_1 The compiler/linker shall be checked to ensure that 31 character
...
* signifiance and case sensitivity are supported for external identifiers.
*/
#define PORT_AR_RELEASE_MINOR_VERSION_IPW_H     3
/**
* @violates @ref PORT_IPW_H_REF_1 The compiler/linker shall be checked to ensure that 31 character
* signifiance and case sensitivity are supported for external identifiers.
*/
#define PORT_AR_RELEASE_REVISION_VERSION_IPW_H  1
