...
/** @violates @ref Crcu_Ipw_h_REF_3 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_IPW_AR_RELEASE_MAJOR_VERSION       4
/** @violates @ref Crcu_Ipw_h_REF_3 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_IPW_AR_RELEASE_MINOR_VERSION       3
/** @violates @ref Crcu_Ipw_h_REF_3 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_IPW_AR_RELEASE_REVISION_VERSION    1
...
* @param[in]    pchannelConfigPtr - Pointer to channel configuration data
*
...
*/
/** @violates @ref Crcu_Ipw_h_REF_1 A function should be used in preference to a function-like macro */
#define Crcu_Ipw_SetChannelConfig(channel, pchannelConfigPtr, retValue)       \
do                                                                           \
{                                                                            \
    (retValue) = Crcu_Crcv2_SetChannelConfig((channel), (pchannelConfigPtr)); \
}                                                                            \
while(0)
