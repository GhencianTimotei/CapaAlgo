...
/** @violates @ref Crcu_Crcv2_h_REF_2 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_CRCV2_AR_RELEASE_MAJOR_VERSION     4
/** @violates @ref Crcu_Crcv2_h_REF_2 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_CRCV2_AR_RELEASE_MINOR_VERSION     3
/** @violates @ref Crcu_Crcv2_h_REF_2 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_CRCV2_AR_RELEASE_REVISION_VERSION  1
