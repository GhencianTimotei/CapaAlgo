...
/** @violates @ref Crcu_Ipw_c_REF_3 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_IPW_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref Crcu_Ipw_c_REF_3 The compiler/linker shall be checked to ensure that 31
    character significance and case sensitivity are supported for external identifiers. */
#define CRCU_IPW_AR_RELEASE_REVISION_VERSION_C  1
...
* @param[in]    pu8DataPtr  - Pointer to the buffer to perform CRC on
...
)
{
    ...
    crcuDmaTcdConfig.u32saddr     = (uint32)pu8DataPtr;              /* Source address                   */
