...
#define ADC_AR_RELEASE_MINOR_VERSION_TYPES          3
/** @violates @ref Adc_Types_h_REF_3 MISRA-C:2004 Rule 1.4: 31 character significance */
#define ADC_AR_RELEASE_REVISION_VERSION_TYPES       1
...
typedef struct
{
    ...
    VAR(uint8, AUTOMATIC) Adc_au8Calibrate_Failed_Steps[ADCDIG_MAX_CALIBRATION_STEPS];
#endif
