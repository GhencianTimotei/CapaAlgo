...
| 2018-03-02 3.70.00 Rli    LOCAL_INLINE definition for FlexCAN3 and FlexCAN2 based derivatives with GHS, GNU, IAR added
| 2018-08-17 3.71.00 Ht     Added V_COMP_GNU_BCM8910X
| 2018-09-24 3.72.00 Hum    Added V_COMP_IAR_TRAVEO2
| 2018-09-28 3.72.01 Hum    Added ALM filter attribute for V_COMP_IAR_TRAVEO2
| 2019-03-04 3.73.00 Ap     Added V_COMP_IAR_MKW35
|                    Hum    Added LOCAL_INLINE definition for V_COMP_IAR_SAM
| 2019-03-04 3.74.00 Bns    Added LOCAL_INLINE definition for TRICORE
|                    Jan    Added V_COMP_GHS_RCARARM
|                    Jan    Change LOCAL_INLINE definition for V_COMP_GHS_TRAVEO
| 2019-07-16 3.75.00 Ht     Added V_COMP_GHS_TRAVEO2
|                    Hum    Added V_COMP_TI_AWR1
| 2019-09-02 3.76.00 Bmo    Added V_COMP_GHS_KEA
| 2019-11-27 3.77.00 Bmo    Added V_COMP_ARM_TLE986X
| 2019-12-04 3.78.00 Pl     Added V_COMP_GNU_TCC800X
|                    Ht     replace C_COMP_ARM_TCC800X_CCAN with V_COMP_ARM_TCC800X
| 2019-12-20 3.79.00 Ht     replace C_COMP_ARM_STM32_BXCAN with V_COMP_ARM_STM32
|                           replace C_COMP_IAR_STM32_BXCAN with V_COMP_IAR_STM32
|                           replace C_COMP_GNU_STM32_BXCAN with V_COMP_GNU_STM32
| 2020-01-22 3.80.00 Pl     Added V_COMP_IAR_TRAVEO
|                    Ht     Replace C_COMP_GNU_TRICORE_MULTICAN by V_COMP_GNU_TRICORE
|                           Replace C_COMP_TASKING_TRICORE_MULTICAN by V_COMP_TASKING_TRICORE
|                           Replace C_COMP_GHS_TRICORE_MULTICAN by V_COMP_GHS_TRICORE
| 2020-02-21 3.81.00 Ap     Added V_COMP_GNU_AVR
| 2020-03-05 3.82.00 TMo    Added V_COMP_CADENCE_GW5
|                    Ht     Removed support for C_COMP_HIWARE_08, C_COMP_HIWARE_12, C_COMP_HIWARE_ST7, C_COMP_HIWARE_ST7_BECAN
|                    Ht     Removed support for C_COMP_NEC_78K0_AFCAN, C_COMP_NEC_78K0, C_COMP_NEC_78K0R
|                    Ht     Removed support for C_COMP_TOSHIBA_TLC900, C_COMP_TOSHIBA_TLCS900, C_COMP_TOSHIBA_TLCS870
|                    Ht     Removed support for C_COMP_HITECH_PIC18
| 2020-03-11 3.83.00 Bmo    Added V_COMP_IAR_PSOC4
| 2020-05-05 3.84.00 Ap     Added V_COMP_NXP_DSP56800EX
| 2020-06-15 3.85.00 Pl     Added V_COMP_GNU_TCC802X
| 2020-07-23 3.86.00 Ap     Added V_COMP_MICROCHIP_SAM
| 2020-09-30 3.87.00 Naj    Added V_COMP_TI_JACINTO7
| 2020-11-04 3.88.00 TMo    Added V_COMP_ARM6_RCARARM
|                    TMo    Added V_COMP_GNU_XMC4
|                    TMo    Added V_COMP_GNU_TRAVEO2
| 2021-04-19 3.89.00 Ht     Added V_COMP_TI_AWRGEN2
|                    Ap     Added V_COMP_GNU_TLE986X
|                    Ap     Added V_COMP_MICROCHIP_AVR
|                    Ap     Added V_COMP_ARM6_TLE986X
| 2021-05-26 3.90.00 Ht     Added V_COMP_IAR_IMX
|                    JDn    Added V_COMP_LLVMDIAB_ZYNQ7000
|                    JDn    Added V_COMP_GHS_ZYNQ7000
|                    JDn    Added V_COMP_GNU_ZYNQ7000
|****************************************************************************/
...
#define COMMON_VDEF_VERSION            0x0390
...
# error "driver not supported or V_COMP_xxx_yyy not defined"
#endif
...
/* polyspace <MISRA-C3:D4.6,2.3 : Not a defect: Justify with annotations > unsigned char provides information about its size */
...
/* polyspace:begin < MISRA-C3:2.3,2.4,6.1 : Not a defect : Justify with annotations > Should be kept for future usage */
struct _c_bits8
{
...
/* polyspace:end < MISRA-C3:2.3,2.4,6.1 : Not a defect : Justify with annotations > Should be kept for future usage */
/* polyspace:begin < MISRA-C3:2.3,2.4,6.1 : Not a defect : Justify with annotations > struct should be kept for future usage */
struct _c_bits16
{
...
/* polyspace:end < MISRA-C3:2.3,2.4,6.1 : Not a defect : Justify with annotations > struct should be kept for future usage */
/* polyspace:begin < MISRA-C3:2.3,2.4,6.1 : Not a defect : Justify with annotations > Should be kept for future usage */
struct _c_bits32
{
  vbittype  b7:1;   /* lower adr */
...
/* ARM32 with TI compiler */

/* ARM32 with ARM6 compiler */
...
#ifndef NULL
/* polyspace+1 MISRA-C3:21.1 [Justified:Low] "Intentionally added" */
# define NULL V_NULL
#endif


/*-----------------------------------------------------------------------------------------------*/
/* polyspace+32 MISRA-C3:2.5 [Justified:Low] "Macro should be kept for future usage" */
#if !defined(V_ENABLE_CAN_ASR_ABSTRACTION) && !defined(V_ENABLE_VSTDLIB_ASR_ABSTRACTION)
...
/* polyspace+25 MISRA-C3:D4.9 [Justified:Low] "Macro used to facilitate easier configuration." */
