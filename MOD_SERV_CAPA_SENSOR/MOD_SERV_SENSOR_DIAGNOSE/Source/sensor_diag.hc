 ...
 ******************************************************************************
 *
 *  $Workfile:   sensor_diag.hc  $
 *  $Revision:   1.2  $
 *  $Date:   May 30 2018 14:03:48  $
 *  $Author:   ybadal  $
 *
 ******************************************************************************
 * Change history:
...
Author      : ybadal
Input       :
Description :  define this to use P40 Tool0 pin for data output
------------------------------------------------------------------------*/
/* polyspace<MISRA-C3:2.5: Not a defect : Justify with annotations > Macro P40_DATA_PIN is used in sensor_diag.c */
/* #define P40_DATA_PIN */
 ...
 * 
 *    Rev 1.2   May 30 2018 14:03:48   ybadal
 * RS232_PORT_HW changed.
 * 
 *    Rev 1.1   29 Nov 2017 08:47:30   sbhanda
 * Base for SW release V01.01
 * 
 *    Rev 1.0   Sep 22 2017 16:12:20   Sbhanda
 * Initial revision.
 * 
 *    Rev 1.1   Aug 07 2017 14:13:52   ybadal
 * the port pin definition is moved to hc file
 * 
