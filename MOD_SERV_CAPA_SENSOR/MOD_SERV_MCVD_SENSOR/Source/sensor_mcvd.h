...
typedef struct
{
    U16 U16_filter_unit_result;/**/
      ...
      U24 U24_Filter_Average_summe;
      U16 U16_standard_dev_threshold;/**/
      U16 U16_Filter_Average;/**/
      U16 U16_standard_deviation;/**/
      U16 U16_max_standard_deviation;/**/
      U8 U8_avg_recal_time;/* counter to be count if the sensor value corrupted */
      U8 U8_avg_counter;/* counter to be count if the sensor in rain mode  */
      #endif

   #ifdef DISTURBANCE_ACTIVE
      U8 U8_disturbance_delay;/* delay to disactivation of the plausibity check   */
   #endif

   #ifdef RAIN_MODE_DETECTION
      U16 U16_rain_old_value;
      U8 U8_peak_counter;
      XINT BO_rain_flag : 1;/* flag to set by detecting rain */
      XINT BO_rain_dist_detect : 1;/* flag to set by detecting the rain disturbance */
      XINT BO_rain_Hand_detect : 1;/* flag to set by detecting the rain disturbance */
   #endif
