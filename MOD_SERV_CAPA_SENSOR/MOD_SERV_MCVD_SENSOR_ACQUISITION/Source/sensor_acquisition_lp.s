...
RIGHT_SHIFT_MEASURED_VALUE_UNLOCK equ 0;
    ...
    PUBLIC _SensorAcq_mcvd_both_scan_LP
...
Generate_Acquisition_Signal:
    ...
    BX LR
DischargeADC_lp:
    LDR    R4, =ADC_VREF_MASK_ASM; /*R4 keeps the value of mask used for ADC ref*/
    ORR    R4, R4, R2;
    STR    R4, [R1];
    ; Measuring the reference value will discharge the capacitor used for ADC measurements
    RefVal:
        LDR    R1, =0x4003B000u;           
        LDR    R2, [R1];                   
